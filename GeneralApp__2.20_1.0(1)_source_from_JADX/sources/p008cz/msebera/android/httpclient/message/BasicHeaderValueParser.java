...
public class BasicHeaderValueParser implements HeaderValueParser {
    ...
    public static HeaderElement[] parseElements(String value, HeaderValueParser parser) throws ParseException {
        ...
        buffer.append(value);
        return (parser != null ? parser : INSTANCE).parseElements(buffer, new ParserCursor(0, value.length()));
    }
    ...
    public static HeaderElement parseHeaderElement(String value, HeaderValueParser parser) throws ParseException {
        ...
        CharArrayBuffer buffer = new CharArrayBuffer(value.length());
        buffer.append(value);
        return (parser != null ? parser : INSTANCE).parseHeaderElement(buffer, new ParserCursor(0, value.length()));
    }
    ...
    public static NameValuePair[] parseParameters(String value, HeaderValueParser parser) throws ParseException {
        ...
        CharArrayBuffer buffer = new CharArrayBuffer(value.length());
        buffer.append(value);
        return (parser != null ? parser : INSTANCE).parseParameters(buffer, new ParserCursor(0, value.length()));
    }
    ...
    public static NameValuePair parseNameValuePair(String value, HeaderValueParser parser) throws ParseException {
        ...
        CharArrayBuffer buffer = new CharArrayBuffer(value.length());
        buffer.append(value);
        return (parser != null ? parser : INSTANCE).parseNameValuePair(buffer, new ParserCursor(0, value.length()));
    }
