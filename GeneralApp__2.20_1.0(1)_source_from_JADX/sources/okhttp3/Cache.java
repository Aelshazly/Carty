...
public final class Cache implements Closeable, Flushable {
    ...
    private static final class CacheResponseBody extends ResponseBody {
        ...
        public CacheResponseBody(Snapshot snapshot2, String contentType2, String contentLength2) {
        ...
        public final Snapshot getSnapshot$okhttp() {
        ...
        private final Set<String> varyFields(Headers $this$varyFields) {
            ...
            for (int i = 0; i < size; i++) {
                if (StringsKt.equals("Vary", $this$varyFields.name(i), true)) {
                    ...
                    if (result2 == null) {
                        result2 = new TreeSet(StringsKt.getCASE_INSENSITIVE_ORDER(StringCompanionObject.INSTANCE));
                    }
                    for (String varyField : StringsKt.split$default((CharSequence) value, new char[]{','}, false, 0, 6, (Object) null)) {
                        if (varyField != null) {
                            result2.add(StringsKt.trim((CharSequence) varyField).toString());
                        } else {
            ...
            return result2 != null ? result2 : SetsKt.emptySet();
        }
    ...
    private static final class Entry {
        ...
        @Metadata(mo24950bv = {1, 0, 3}, mo24951d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0002\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0004X\u0004¢\u0006\u0002\n\u0000¨\u0006\u0006"}, mo24952d2 = {"Lokhttp3/Cache$Entry$Companion;", "", "()V", "RECEIVED_MILLIS", "", "SENT_MILLIS", "okhttp"}, mo24953k = 1, mo24954mv = {1, 1, 15})
        /* compiled from: Cache.kt */
        public static final class Companion {
            private Companion() {
            }
    ...
    @Metadata(mo24950bv = {1, 0, 3}, mo24951d1 = {"\u0000,\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0002\b\u0005\n\u0002\u0010\u0002\n\u0000\b\u0004\u0018\u00002\u00020\u0001B\u0013\b\u0000\u0012\n\u0010\u0002\u001a\u00060\u0003R\u00020\u0004¢\u0006\u0002\u0010\u0005J\b\u0010\u000f\u001a\u00020\u0010H\u0016J\b\u0010\u0006\u001a\u00020\u0007H\u0016R\u000e\u0010\u0006\u001a\u00020\u0007X\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\b\u001a\u00020\u0007X\u0004¢\u0006\u0002\n\u0000R\u001a\u0010\t\u001a\u00020\nX\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u000b\u0010\f\"\u0004\b\r\u0010\u000eR\u0012\u0010\u0002\u001a\u00060\u0003R\u00020\u0004X\u0004¢\u0006\u0002\n\u0000¨\u0006\u0011"}, mo24952d2 = {"Lokhttp3/Cache$RealCacheRequest;", "Lokhttp3/internal/cache/CacheRequest;", "editor", "Lokhttp3/internal/cache/DiskLruCache$Editor;", "Lokhttp3/internal/cache/DiskLruCache;", "(Lokhttp3/Cache;Lokhttp3/internal/cache/DiskLruCache$Editor;)V", "body", "Lokio/Sink;", "cacheOut", "done", "", "getDone$okhttp", "()Z", "setDone$okhttp", "(Z)V", "abort", "", "okhttp"}, mo24953k = 1, mo24954mv = {1, 1, 15})
    /* compiled from: Cache.kt */
    private final class RealCacheRequest implements CacheRequest {
        ...
        public RealCacheRequest(Cache $outer, Editor editor2) {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:12:0x0019, code lost:
            okhttp3.internal.Util.closeQuietly((java.io.Closeable) r5.cacheOut);
         */
        ...
        public void abort() {
            /*
                ...
                monitor-enter(r0)
                r1 = 0
                boolean r2 = r5.done     // Catch:{ all -> 0x002a }
                if (r2 == 0) goto L_0x000a
                monitor-exit(r0)
                return
            L_0x000a:
                r2 = 1
                r5.done = r2     // Catch:{ all -> 0x002a }
                okhttp3.Cache r3 = r5.this$0     // Catch:{ all -> 0x002a }
                int r4 = r3.getWriteAbortCount$okhttp()     // Catch:{ all -> 0x002a }
                int r4 = r4 + r2
                r3.setWriteAbortCount$okhttp(r4)     // Catch:{ all -> 0x002a }
                monitor-exit(r0)
                okio.Sink r0 = r5.cacheOut
                java.io.Closeable r0 = (java.io.Closeable) r0
                okhttp3.internal.Util.closeQuietly(r0)
                okhttp3.internal.cache.DiskLruCache$Editor r0 = r5.editor     // Catch:{ IOException -> 0x0027 }
                r0.abort()     // Catch:{ IOException -> 0x0027 }
                goto L_0x0028
            L_0x0027:
                r0 = move-exception
            L_0x0028:
    ...
    public Cache(File directory, long maxSize, FileSystem fileSystem) {
        ...
        this.cache = DiskLruCache.Companion.create(fileSystem, directory, VERSION, 2, maxSize);
    }
    ...
    public final CacheRequest put$okhttp(Response response) {
        ...
        if (HttpMethod.INSTANCE.invalidatesCache(response.request().method())) {
            ...
            try {
                Editor edit$default = DiskLruCache.edit$default(this.cache, Companion.key(response.request().url()), 0, 2, null);
                if (edit$default == null) {
                    return null;
                }
                Editor editor = edit$default;
    ...
    public final void update$okhttp(Response cached, Response network) {
        ...
        if (body != null) {
            try {
                Editor editor = ((CacheResponseBody) body).getSnapshot$okhttp().edit();
                if (editor != null) {
                    entry.writeTo(editor);
                    editor.commit();
                }
    ...
    public final File m2252deprecated_directory() {
        return this.cache.getDirectory();
    }
