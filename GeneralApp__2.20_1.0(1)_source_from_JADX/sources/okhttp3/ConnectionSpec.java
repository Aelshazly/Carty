...
public final class ConnectionSpec {
    ...
    public static final class Builder {
        ...
        public final Builder cipherSuites(CipherSuite... cipherSuites2) {
            ...
            if ($this$apply.tls) {
                ...
                int length = cipherSuiteArr2.length;
                for (int i = 0; i < length; i++) {
                    destination$iv$iv.add(cipherSuiteArr2[i].javaName());
                }
        ...
        public final Builder tlsVersions(TlsVersion... tlsVersions2) {
            ...
            if ($this$apply.tls) {
                ...
                TlsVersion[] tlsVersionArr2 = tlsVersionArr;
                int length = tlsVersionArr2.length;
                for (int i = 0; i < length; i++) {
                    destination$iv$iv.add(tlsVersionArr2[i].javaName());
                }
                Object[] array = ((List) destination$iv$iv).toArray(new String[0]);
                if (array != null) {
                    String[] strings = (String[]) array;
    ...
    @Metadata(mo24950bv = {1, 0, 3}, mo24951d1 = {"\u0000 \n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u0011\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0005\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u0016\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004X\u0004¢\u0006\u0004\n\u0002\u0010\u0006R\u0010\u0010\u0007\u001a\u00020\b8\u0006X\u0004¢\u0006\u0002\n\u0000R\u0010\u0010\t\u001a\u00020\b8\u0006X\u0004¢\u0006\u0002\n\u0000R\u0010\u0010\n\u001a\u00020\b8\u0006X\u0004¢\u0006\u0002\n\u0000R\u0016\u0010\u000b\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004X\u0004¢\u0006\u0004\n\u0002\u0010\u0006R\u0010\u0010\f\u001a\u00020\b8\u0006X\u0004¢\u0006\u0002\n\u0000¨\u0006\r"}, mo24952d2 = {"Lokhttp3/ConnectionSpec$Companion;", "", "()V", "APPROVED_CIPHER_SUITES", "", "Lokhttp3/CipherSuite;", "[Lokhttp3/CipherSuite;", "CLEARTEXT", "Lokhttp3/ConnectionSpec;", "COMPATIBLE_TLS", "MODERN_TLS", "RESTRICTED_CIPHER_SUITES", "RESTRICTED_TLS", "okhttp"}, mo24953k = 1, mo24954mv = {1, 1, 15})
    /* compiled from: ConnectionSpec.kt */
    ...
    public final List<CipherSuite> m2268deprecated_cipherSuites() {
        return cipherSuites();
    }
    ...
    public final List<TlsVersion> m2270deprecated_tlsVersions() {
        return tlsVersions();
    }
    ...
    public final boolean m2269deprecated_supportsTlsExtensions() {
        return this.supportsTlsExtensions;
    }
    ...
    private final ConnectionSpec supportedSpec(SSLSocket sslSocket, boolean isFallback) {
        ...
        if (isFallback && indexOfFallbackScsv != -1) {
            Intrinsics.checkExpressionValueIsNotNull(cipherSuitesIntersection, str);
            String str2 = supportedCipherSuites[indexOfFallbackScsv];
            Intrinsics.checkExpressionValueIsNotNull(str2, "supportedCipherSuites[indexOfFallbackScsv]");
            cipherSuitesIntersection = Util.concat(cipherSuitesIntersection, str2);
        }
