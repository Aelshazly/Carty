...
public final class Challenge {
    ...
    public Challenge(String scheme2, Map<String, String> authParams2) {
        ...
        Map<String, String> map = authParams2;
        for (Entry entry : authParams2.entrySet()) {
    ...
    public Challenge(String scheme2, String realm) {
        Intrinsics.checkParameterIsNotNull(scheme2, "scheme");
        String str = "realm";
        Intrinsics.checkParameterIsNotNull(realm, str);
        Map singletonMap = Collections.singletonMap(str, realm);
        Intrinsics.checkExpressionValueIsNotNull(singletonMap, "singletonMap(\"realm\", realm)");
        this(scheme2, singletonMap);
    }
    ...
    public final Charset m2264deprecated_charset() {
        return charset();
    }
