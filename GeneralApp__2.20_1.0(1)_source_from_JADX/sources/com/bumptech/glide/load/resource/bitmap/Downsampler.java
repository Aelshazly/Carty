...
public final class Downsampler {
    ...
    public Resource<Bitmap> decode(InputStream is, int requestedWidth, int requestedHeight, com.bumptech.glide.load.Options options, DecodeCallbacks callbacks) throws IOException {
        ...
        try {
            return BitmapResource.obtain(decodeFromWrappedStreams(is, bitmapFactoryOptions, (DownsampleStrategy) options2.get(DownsampleStrategy.OPTION), (DecodeFormat) options2.get(DECODE_FORMAT), options2.get(ALLOW_HARDWARE_CONFIG) != null && ((Boolean) options2.get(ALLOW_HARDWARE_CONFIG)).booleanValue(), requestedWidth, requestedHeight, ((Boolean) options2.get(FIX_BITMAP_SIZE_TO_REQUESTED_DIMENSIONS)).booleanValue(), callbacks), this.bitmapPool);
        } finally {
