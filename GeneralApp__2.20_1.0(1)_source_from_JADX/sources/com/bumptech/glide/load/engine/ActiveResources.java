...
final class ActiveResources {
    ...
    public synchronized void activate(Key key, EngineResource<?> resource) {
        ResourceWeakReference removed = (ResourceWeakReference) this.activeEngineResources.put(key, new ResourceWeakReference(key, resource, this.resourceReferenceQueue, this.isActiveResourceRetentionAllowed));
        if (removed != null) {
            removed.reset();
        }
    }
