...
public final class SingleRequest<R> implements Request, SizeReadyCallback, ResourceCallback, Poolable {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:23:0x00af A[Catch:{ all -> 0x00c2 }] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private synchronized void onResourceReady(com.bumptech.glide.load.engine.Resource<R> r12, R r13, com.bumptech.glide.load.DataSource r14) {
        /*
            r11 = this;
            monitor-enter(r11)
            boolean r0 = r11.isFirstReadyResource()     // Catch:{ all -> 0x00c6 }
            com.bumptech.glide.request.SingleRequest$Status r1 = com.bumptech.glide.request.SingleRequest.Status.COMPLETE     // Catch:{ all -> 0x00c6 }
            r11.status = r1     // Catch:{ all -> 0x00c6 }
            r11.resource = r12     // Catch:{ all -> 0x00c6 }
            com.bumptech.glide.GlideContext r1 = r11.glideContext     // Catch:{ all -> 0x00c6 }
            int r1 = r1.getLogLevel()     // Catch:{ all -> 0x00c6 }
            r2 = 3
            ...
            java.lang.Class r3 = r13.getClass()     // Catch:{ all -> 0x00c6 }
            java.lang.String r3 = r3.getSimpleName()     // Catch:{ all -> 0x00c6 }
            r2.append(r3)     // Catch:{ all -> 0x00c6 }
            java.lang.String r3 = " from "
            r2.append(r3)     // Catch:{ all -> 0x00c6 }
            r2.append(r14)     // Catch:{ all -> 0x00c6 }
            java.lang.String r3 = " for "
            r2.append(r3)     // Catch:{ all -> 0x00c6 }
            java.lang.Object r3 = r11.model     // Catch:{ all -> 0x00c6 }
            r2.append(r3)     // Catch:{ all -> 0x00c6 }
            java.lang.String r3 = " with size ["
            r2.append(r3)     // Catch:{ all -> 0x00c6 }
            int r3 = r11.width     // Catch:{ all -> 0x00c6 }
            r2.append(r3)     // Catch:{ all -> 0x00c6 }
            java.lang.String r3 = "x"
            r2.append(r3)     // Catch:{ all -> 0x00c6 }
            int r3 = r11.height     // Catch:{ all -> 0x00c6 }
            r2.append(r3)     // Catch:{ all -> 0x00c6 }
            java.lang.String r3 = "] in "
            r2.append(r3)     // Catch:{ all -> 0x00c6 }
            long r3 = r11.startTime     // Catch:{ all -> 0x00c6 }
            double r3 = com.bumptech.glide.util.LogTime.getElapsedMillis(r3)     // Catch:{ all -> 0x00c6 }
            r2.append(r3)     // Catch:{ all -> 0x00c6 }
            java.lang.String r3 = " ms"
            r2.append(r3)     // Catch:{ all -> 0x00c6 }
            java.lang.String r2 = r2.toString()     // Catch:{ all -> 0x00c6 }
            android.util.Log.d(r1, r2)     // Catch:{ all -> 0x00c6 }
        L_0x006c:
            r7 = 1
            r11.isCallingCallbacks = r7     // Catch:{ all -> 0x00c6 }
            r1 = 0
            r8 = 0
            java.util.List<com.bumptech.glide.request.RequestListener<R>> r2 = r11.requestListeners     // Catch:{ all -> 0x00c2 }
            if (r2 == 0) goto L_0x0095
            java.util.List<com.bumptech.glide.request.RequestListener<R>> r2 = r11.requestListeners     // Catch:{ all -> 0x00c2 }
            java.util.Iterator r9 = r2.iterator()     // Catch:{ all -> 0x00c2 }
            r10 = r1
        L_0x007c:
            boolean r1 = r9.hasNext()     // Catch:{ all -> 0x00c2 }
            if (r1 == 0) goto L_0x0096
            java.lang.Object r1 = r9.next()     // Catch:{ all -> 0x00c2 }
            com.bumptech.glide.request.RequestListener r1 = (com.bumptech.glide.request.RequestListener) r1     // Catch:{ all -> 0x00c2 }
            java.lang.Object r3 = r11.model     // Catch:{ all -> 0x00c2 }
            com.bumptech.glide.request.target.Target<R> r4 = r11.target     // Catch:{ all -> 0x00c2 }
            r2 = r13
            r5 = r14
            r6 = r0
            boolean r2 = r1.onResourceReady(r2, r3, r4, r5, r6)     // Catch:{ all -> 0x00c2 }
            r10 = r10 | r2
            goto L_0x007c
        L_0x0095:
            r10 = r1
        L_0x0096:
            com.bumptech.glide.request.RequestListener<R> r1 = r11.targetListener     // Catch:{ all -> 0x00c2 }
            ...
            r5 = r14
            r6 = r0
            boolean r1 = r1.onResourceReady(r2, r3, r4, r5, r6)     // Catch:{ all -> 0x00c2 }
            if (r1 == 0) goto L_0x00aa
            goto L_0x00ab
        L_0x00aa:
            r7 = 0
        L_0x00ab:
            ...
            com.bumptech.glide.request.transition.TransitionFactory<? super R> r2 = r11.animationFactory     // Catch:{ all -> 0x00c2 }
            com.bumptech.glide.request.transition.Transition r2 = r2.build(r14, r0)     // Catch:{ all -> 0x00c2 }
            com.bumptech.glide.request.target.Target<R> r3 = r11.target     // Catch:{ all -> 0x00c2 }
            r3.onResourceReady(r13, r2)     // Catch:{ all -> 0x00c2 }
        L_0x00ba:
            r11.isCallingCallbacks = r8     // Catch:{ all -> 0x00c6 }
            r11.notifyLoadSuccess()     // Catch:{ all -> 0x00c6 }
            monitor-exit(r11)
            return
        L_0x00c2:
            r1 = move-exception
