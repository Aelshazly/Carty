...
public final class zziy extends zze {
    ...
    private final void zza(Activity activity, zziv zziv, boolean z) {
        zziv zziv2;
        zziv zziv3 = this.zzb == null ? this.zzc : this.zzb;
        if (zziv.zzb == null) {
            zziv2 = new zziv(zziv.zza, zza(activity.getClass().getCanonicalName()), zziv.zzc);
        } else {
            zziv2 = zziv;
        }
        this.zzc = this.zzb;
        ...
        zzgj zzq = zzq();
        zzix zzix = new zzix(this, z, elapsedRealtime, zziv3, zziv2);
    ...
    public static void zza(zziv zziv, Bundle bundle, boolean z) {
        ...
        String str2 = "_sn";
        String str3 = "_sc";
        if (bundle == null || zziv == null || (bundle.containsKey(str3) && !z)) {
            if (bundle != null && zziv == null && z) {
                bundle.remove(str2);
                bundle.remove(str3);
                bundle.remove(str);
            }
        ...
        if (zziv.zza != null) {
            bundle.putString(str2, zziv.zza);
        } else {
            bundle.remove(str2);
        }
        bundle.putString(str3, zziv.zzb);
        bundle.putLong(str, zziv.zzc);
    }
    ...
    private final zziv zzd(Activity activity) {
        ...
        zziv zziv = (zziv) this.zzd.get(activity);
        if (zziv != null) {
            return zziv;
        }
        zziv zziv2 = new zziv(null, zza(activity.getClass().getCanonicalName()), zzp().zzg());
    ...
    public final void zza(Activity activity, Bundle bundle) {
        if (bundle != null) {
            ...
            if (bundle2 != null) {
                this.zzd.put(activity, new zziv(bundle2.getString("name"), bundle2.getString("referrer_name"), bundle2.getLong("id")));
            }
        }
    }
    ...
    public final void zzb(Activity activity, Bundle bundle) {
        if (bundle != null) {
            ...
            if (zziv != null) {
                ...
                bundle2.putString("name", zziv.zza);
