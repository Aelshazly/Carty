...
public final class zzjr implements ServiceConnection, BaseConnectionCallbacks, BaseOnConnectionFailedListener {
    ...
    public final void onServiceConnected(ComponentName componentName, IBinder iBinder) {
        ...
        synchronized (this) {
                ...
                if ("com.google.android.gms.measurement.internal.IMeasurementService".equals(interfaceDescriptor)) {
                    if (iBinder != null) {
                        ...
                        if (queryLocalInterface instanceof zzfb) {
                            zzfb = (zzfb) queryLocalInterface;
                        } else {
                            zzfb = new zzfd(iBinder);
                        }
                    }
            ...
            if (zzfb == null) {
                ...
                this.zza.zzq().zza((Runnable) new zzju(this, zzfb));
            }
        }
    }
