...
public final class zzge {
    ...
    public static final class zza extends zzcg<zza, C1736zza> implements zzdq {
        ...
        public static final class C1736zza extends com.google.android.gms.internal.clearcut.zzcg.zza<zza, C1736zza> implements zzdq {
            private C1736zza() {
                super(zza.zzsm);
            }

            /* synthetic */ C1736zza(zzgf zzgf) {
                this();
            }
        }
    ...
    public static final class zzq extends com.google.android.gms.internal.clearcut.zzcg.zzd<zzq, zza> implements zzdq {
        ...
        public enum zzb implements zzcj {
            ...
            GEARHEAD_ANDROID_PRIMES(HttpStatus.SC_CREATED),
            ...
            EARTH(334),
            EARTH_COUNTERS(HttpStatus.SC_METHOD_NOT_ALLOWED),
            CALENDAR_CLIENT(335),
            ...
            CORP_ANDROID_JETSET(HttpStatus.SC_PAYMENT_REQUIRED),
            VR_SDK_IOS_PRIMES(HttpStatus.SC_FORBIDDEN),
            VR_SDK_ANDROID_PRIMES(HttpStatus.SC_NOT_FOUND),
            PHOTOS_SCANNER(HttpStatus.SC_NOT_ACCEPTABLE),
            BG_IN_OGB(HttpStatus.SC_PROXY_AUTHENTICATION_REQUIRED),
            BLOGGER(HttpStatus.SC_REQUEST_TIMEOUT),
            CORP_IOS_FOOD(HttpStatus.SC_CONFLICT),
            BEACON_GCORE_TEST(HttpStatus.SC_GONE),
            LINKS_IOS_PRIMES(HttpStatus.SC_LENGTH_REQUIRED),
            CHAUFFEUR(HttpStatus.SC_PRECONDITION_FAILED),
            SNAPSEED(HttpStatus.SC_REQUEST_TOO_LONG),
