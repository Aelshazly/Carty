...
public class zzbw {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:37:0x00b0, code lost:
        r10 = r10.query(zza, null, null, new java.lang.String[]{r11}, null);
     */
    ...
    public static java.lang.String zza(android.content.ContentResolver r10, java.lang.String r11, java.lang.String r12) {
        /*
            ...
            monitor-enter(r12)
            java.util.HashMap<java.lang.String, java.lang.String> r0 = zzf     // Catch:{ all -> 0x00f7 }
            r1 = 1
            r2 = 0
            r3 = 0
            if (r0 != 0) goto L_0x002b
            java.util.concurrent.atomic.AtomicBoolean r0 = zze     // Catch:{ all -> 0x00f7 }
            r0.set(r2)     // Catch:{ all -> 0x00f7 }
            java.util.HashMap r0 = new java.util.HashMap     // Catch:{ all -> 0x00f7 }
            r0.<init>()     // Catch:{ all -> 0x00f7 }
            zzf = r0     // Catch:{ all -> 0x00f7 }
            java.lang.Object r0 = new java.lang.Object     // Catch:{ all -> 0x00f7 }
            r0.<init>()     // Catch:{ all -> 0x00f7 }
            zzk = r0     // Catch:{ all -> 0x00f7 }
            zzl = r2     // Catch:{ all -> 0x00f7 }
            android.net.Uri r0 = zza     // Catch:{ all -> 0x00f7 }
            com.google.android.gms.internal.measurement.zzbv r4 = new com.google.android.gms.internal.measurement.zzbv     // Catch:{ all -> 0x00f7 }
        ...
        L_0x002b:
            ...
            java.util.HashMap<java.lang.String, java.lang.Boolean> r0 = zzg     // Catch:{ all -> 0x00f7 }
            r0.clear()     // Catch:{ all -> 0x00f7 }
            java.util.HashMap<java.lang.String, java.lang.Integer> r0 = zzh     // Catch:{ all -> 0x00f7 }
            r0.clear()     // Catch:{ all -> 0x00f7 }
            java.util.HashMap<java.lang.String, java.lang.Long> r0 = zzi     // Catch:{ all -> 0x00f7 }
            r0.clear()     // Catch:{ all -> 0x00f7 }
            java.util.HashMap<java.lang.String, java.lang.Float> r0 = zzj     // Catch:{ all -> 0x00f7 }
            r0.clear()     // Catch:{ all -> 0x00f7 }
            java.lang.Object r0 = new java.lang.Object     // Catch:{ all -> 0x00f7 }
            r0.<init>()     // Catch:{ all -> 0x00f7 }
            zzk = r0     // Catch:{ all -> 0x00f7 }
            zzl = r2     // Catch:{ all -> 0x00f7 }
        L_0x0055:
            java.lang.Object r0 = zzk     // Catch:{ all -> 0x00f7 }
            java.util.HashMap<java.lang.String, java.lang.String> r4 = zzf     // Catch:{ all -> 0x00f7 }
            boolean r4 = r4.containsKey(r11)     // Catch:{ all -> 0x00f7 }
            if (r4 == 0) goto L_0x006d
            java.util.HashMap<java.lang.String, java.lang.String> r10 = zzf     // Catch:{ all -> 0x00f7 }
        ...
        L_0x006b:
            ...
            return r10
        L_0x006d:
            java.lang.String[] r4 = zzm     // Catch:{ all -> 0x00f7 }
        ...
        L_0x0071:
            ...
            boolean r0 = zzl     // Catch:{ all -> 0x00f7 }
            if (r0 == 0) goto L_0x0087
            java.util.HashMap<java.lang.String, java.lang.String> r0 = zzf     // Catch:{ all -> 0x00f7 }
            boolean r0 = r0.isEmpty()     // Catch:{ all -> 0x00f7 }
            if (r0 == 0) goto L_0x00aa
        L_0x0087:
            java.lang.String[] r0 = zzm     // Catch:{ all -> 0x00f7 }
            java.util.HashMap<java.lang.String, java.lang.String> r2 = zzf     // Catch:{ all -> 0x00f7 }
            java.util.Map r10 = zza(r10, r0)     // Catch:{ all -> 0x00f7 }
            r2.putAll(r10)     // Catch:{ all -> 0x00f7 }
            zzl = r1     // Catch:{ all -> 0x00f7 }
            java.util.HashMap<java.lang.String, java.lang.String> r10 = zzf     // Catch:{ all -> 0x00f7 }
