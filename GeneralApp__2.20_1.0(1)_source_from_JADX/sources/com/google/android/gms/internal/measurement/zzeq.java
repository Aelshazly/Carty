...
public class zzeq {
    ...
    public final <ContainingType extends zzgo> zzf<ContainingType, ?> zza(ContainingType containingtype, int i) {
        return (zzf) this.zzf.get(new zza(containingtype, i));
    }
