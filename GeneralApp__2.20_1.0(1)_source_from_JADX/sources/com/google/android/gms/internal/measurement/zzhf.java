...
final class zzhf {
    ...
    static int zza(List<Long> list) {
        ...
        if (list instanceof zzgc) {
            ...
            int i3 = 0;
            while (i2 < size) {
                i3 = i + zzen.zzd(((Long) list.get(i2)).longValue());
                i2++;
            }
        }
        return i;
    ...
    static int zzb(List<Long> list) {
        ...
        if (list instanceof zzgc) {
            ...
            int i3 = 0;
            while (i2 < size) {
                i3 = i + zzen.zze(((Long) list.get(i2)).longValue());
                i2++;
            }
        }
        return i;
    ...
    static int zzc(List<Long> list) {
        ...
        if (list instanceof zzgc) {
            ...
            int i3 = 0;
            while (i2 < size) {
                i3 = i + zzen.zzf(((Long) list.get(i2)).longValue());
                i2++;
            }
        }
        return i;
    ...
    static int zzd(List<Integer> list) {
        ...
        if (list instanceof zzfg) {
            ...
            int i3 = 0;
            while (i2 < size) {
                i3 = i + zzen.zzk(((Integer) list.get(i2)).intValue());
                i2++;
            }
        }
        return i;
    ...
    static int zze(List<Integer> list) {
        ...
        if (list instanceof zzfg) {
            ...
            int i3 = 0;
            while (i2 < size) {
                i3 = i + zzen.zzf(((Integer) list.get(i2)).intValue());
                i2++;
            }
        }
        return i;
    ...
    static int zzf(List<Integer> list) {
        ...
        if (list instanceof zzfg) {
            ...
            int i3 = 0;
            while (i2 < size) {
                i3 = i + zzen.zzg(((Integer) list.get(i2)).intValue());
                i2++;
            }
        }
        return i;
    ...
    static int zzg(List<Integer> list) {
        ...
        if (list instanceof zzfg) {
            ...
            int i3 = 0;
            while (i2 < size) {
                i3 = i + zzen.zzh(((Integer) list.get(i2)).intValue());
                i2++;
            }
        }
        return i;
    ...
    static int zzb(int i, List<zzgo> list, zzhd zzhd) {
        ...
        int i2 = 0;
        for (int i3 = 0; i3 < size; i3++) {
            i2 += zzen.zzc(i, (zzgo) list.get(i3), zzhd);
        }
        return i2;
    }
        ...
        if (list instanceof RandomAccess) {
            ...
            while (it.hasNext()) {
                ...
                if (!zzfk.zza(intValue2)) {
                    UB zza2 = zza(i, intValue2, ub2, zzhv);
                    it.remove();
                    ub2 = zza2;
                }
            }
