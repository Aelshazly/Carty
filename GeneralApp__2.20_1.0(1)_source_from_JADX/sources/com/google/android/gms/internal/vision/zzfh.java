...
public abstract class zzfh implements Serializable, Iterable<Byte> {
    public static final zzfh zzsd = new zzfr(zzgt.zzxi);
    private static final zzfn zzse = (zzfa.zzdr() ? new zzfu(null) : new zzfl(null));
    private static final Comparator<zzfh> zzsf = new zzfj();
    private int zzmm = 0;
    ...
    public static zzfh zza(byte[] bArr, int i, int i2) {
        ...
        return new zzfr(zzse.zzd(bArr, i, i2));
    }
