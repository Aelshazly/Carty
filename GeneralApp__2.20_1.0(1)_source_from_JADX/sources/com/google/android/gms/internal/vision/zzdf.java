...
public abstract class zzdf<E> extends zzdc<E> implements List<E>, RandomAccess {
    private static final zzdq<Object> zzlr = new zzde(zzdi.zzlx, 0);

    public static <E> zzdf<E> zzcd() {
        return zzdi.zzlx;
    }

    static <E> zzdf<E> zza(Object[] objArr) {
    ...
    /* renamed from: zze */
    public zzdf<E> subList(int i, int i2) {
        zzct.zza(i, i2, size());
        int i3 = i2 - i;
        if (i3 == size()) {
            return this;
        ...
        if (obj instanceof List) {
            ...
            if (size == list.size()) {
                if (!(this instanceof RandomAccess) || !(list instanceof RandomAccess)) {
                    ...
                    int i2 = 0;
                    while (i2 < size) {
                        if (zzco.equal(get(i2), list.get(i2))) {
                            i2++;
                        }
                    }
                    return true;
