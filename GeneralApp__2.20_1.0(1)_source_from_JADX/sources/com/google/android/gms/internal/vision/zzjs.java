...
final class zzjs {
    private static final zzjt zzabq;

    public static boolean zzg(byte[] bArr) {
        return zzabq.zzf(bArr, 0, bArr.length);
    }

    public static boolean zzf(byte[] bArr, int i, int i2) {
        return zzabq.zzf(bArr, i, i2);
    }
    ...
    static int zza(CharSequence charSequence, byte[] bArr, int i, int i2) {
        return zzabq.zzb(charSequence, bArr, i, i2);
    }

    static String zzh(byte[] bArr, int i, int i2) throws zzhc {
        return zzabq.zzh(bArr, i, i2);
    }
