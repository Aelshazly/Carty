...
public final class zzl {
    public static boolean zza(Context context, String str, String str2) {
        ...
        String str3 = "NativeLibraryLoader";
        if ("face".equals(str) || "ica".equals(str) || "ocr".equals(str) || "barcode".equals(str)) {
            ...
            if (!zza) {
                Log.d(str3, String.format("%s engine not loaded with %s.", new Object[]{str, zzk}));
            }
            return zza;
        }
        Log.e(str3, String.format("Unrecognized engine: %s", new Object[]{str}));
        return false;
    }
}
