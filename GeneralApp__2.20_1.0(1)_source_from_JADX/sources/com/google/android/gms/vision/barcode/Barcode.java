...
public class Barcode extends AbstractSafeParcelable {
    ...
    public static class CalendarEvent extends AbstractSafeParcelable {
        public static final Creator<CalendarEvent> CREATOR = new zzf();
    ...
    public static class DriverLicense extends AbstractSafeParcelable {
        public static final Creator<DriverLicense> CREATOR = new zzh();
    ...
    public static class GeoPoint extends AbstractSafeParcelable {
        public static final Creator<GeoPoint> CREATOR = new zzj();
        public double lat;
        public double lng;
    ...
    public static class Phone extends AbstractSafeParcelable {
        public static final Creator<Phone> CREATOR = new zzl();
    ...
    public static class UrlBookmark extends AbstractSafeParcelable {
        public static final Creator<UrlBookmark> CREATOR = new zzn();
        public String title;
        public String url;
    ...
    public Barcode(int i, String str, String str2, int i2, Point[] pointArr, Email email2, Phone phone2, Sms sms2, WiFi wiFi, UrlBookmark urlBookmark, GeoPoint geoPoint2, CalendarEvent calendarEvent2, ContactInfo contactInfo2, DriverLicense driverLicense2, byte[] bArr, boolean z) {
        this.format = i;
        this.rawValue = str;
        this.rawBytes = bArr;
