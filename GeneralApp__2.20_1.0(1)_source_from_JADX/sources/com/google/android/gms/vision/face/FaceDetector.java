...
public final class FaceDetector extends Detector<Face> {
    ...
    public final SparseArray<Face> detect(Frame frame) {
        ...
        if (frame != null) {
            ...
            synchronized (this.lock) {
                if (this.zzcm) {
                    zzb = this.zzcl.zzb(byteBuffer, zzp.zzc(frame));
                } else {
            ...
            for (Face face : zzb) {
                ...
                sparseArray.append(this.zzck.zzb(id), face);
            }
            return sparseArray;
        }
    ...
    public final boolean setFocus(int i) {
        boolean zzd;
        int zzc = this.zzck.zzc(i);
        synchronized (this.lock) {
            if (this.zzcm) {
                zzd = this.zzcl.zzd(zzc);
            } else {
                throw new RuntimeException("Cannot use detector after release()");
            }
        }
    ...
    public static boolean zza(zzf zzf) {
        ...
        if (zzf.landmarkType != 2 || zzf.zzcp != 1) {
            return z;
        }
