...
public class RippleUtils {
    ...
    public static ColorStateList sanitizeRippleDrawableColor(ColorStateList rippleColor) {
        ...
        if (VERSION.SDK_INT >= 22 && VERSION.SDK_INT <= 27 && Color.alpha(rippleColor.getDefaultColor()) == 0 && Color.alpha(rippleColor.getColorForState(ENABLED_PRESSED_STATE_SET, 0)) != 0) {
