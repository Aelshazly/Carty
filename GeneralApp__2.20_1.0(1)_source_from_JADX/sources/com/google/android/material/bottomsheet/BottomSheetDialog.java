...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    private FrameLayout ensureContainerAndBehavior() {
        if (this.container == null) {
            this.container = (FrameLayout) View.inflate(getContext(), C1124R.layout.design_bottom_sheet_dialog, null);
            this.behavior = BottomSheetBehavior.from((FrameLayout) this.container.findViewById(C1124R.C1127id.design_bottom_sheet));
    ...
    private View wrapInBottomSheet(int layoutResId, View view, LayoutParams params) {
        ensureContainerAndBehavior();
        CoordinatorLayout coordinator = (CoordinatorLayout) this.container.findViewById(C1124R.C1127id.coordinator);
        if (layoutResId != 0 && view == null) {
            view = getLayoutInflater().inflate(layoutResId, coordinator, false);
        }
        FrameLayout bottomSheet = (FrameLayout) this.container.findViewById(C1124R.C1127id.design_bottom_sheet);
        if (params == null) {
            bottomSheet.addView(view);
        } else {
            bottomSheet.addView(view, params);
        }
        coordinator.findViewById(C1124R.C1127id.touch_outside).setOnClickListener(new OnClickListener() {
    ...
    private static int getThemeResId(Context context, int themeId) {
        ...
        if (context.getTheme().resolveAttribute(C1124R.attr.bottomSheetDialogTheme, outValue, true)) {
            return outValue.resourceId;
        }
        return C1124R.style.Theme_Design_Light_BottomSheetDialog;
    }
