...
public class MaterialButtonToggleGroup extends LinearLayout {
    ...
    public MaterialButtonToggleGroup(Context context, AttributeSet attrs) {
        this(context, attrs, C1124R.attr.materialButtonToggleGroupStyle);
    }
    ...
    public MaterialButtonToggleGroup(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray attributes = ThemeEnforcement.obtainStyledAttributes(context, attrs, C1124R.styleable.MaterialButtonToggleGroup, defStyleAttr, C1124R.style.Widget_MaterialComponents_MaterialButtonToggleGroup, new int[0]);
        setSingleSelection(attributes.getBoolean(C1124R.styleable.MaterialButtonToggleGroup_singleSelection, false));
        this.checkedId = attributes.getResourceId(C1124R.styleable.MaterialButtonToggleGroup_checkedButton, -1);
    ...
    public void updateChildShapes() {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (button.getVisibility() != 8) {
                Builder builder = button.getShapeAppearanceModel().toBuilder();
    ...
    private static void updateBuilderWithCornerData(Builder shapeAppearanceModelBuilder, CornerData cornerData) {
        if (cornerData == null) {
