...
class ViewUtilsLollipop {
    ...
    static void setDefaultAppBarLayoutStateListAnimator(View view, float elevation) {
        int dur = view.getResources().getInteger(C1124R.integer.app_bar_elevation_anim_duration);
        StateListAnimator sla = new StateListAnimator();
        String str = "elevation";
        sla.addState(new int[]{16842766, C1124R.attr.state_liftable, -C1124R.attr.state_lifted}, ObjectAnimator.ofFloat(view, str, new float[]{0.0f}).setDuration((long) dur));
