...
public abstract class FabTransformationBehavior extends ExpandableTransformationBehavior {
    ...
    public AnimatorSet onCreateExpandedStateChangeAnimation(View dependency, View child, boolean expanded, boolean isAnimating) {
        ...
        createTranslationAnimation(view, view2, z2, isAnimating, spec, arrayList3, arrayList4, childBounds);
        float childWidth = childBounds.width();
        float childHeight = childBounds.height();
        createDependencyTranslationAnimation(view, view2, z2, spec, arrayList);
    ...
    private void createTranslationAnimation(View dependency, View child, boolean expanded, boolean currentlyAnimating, FabTransformationSpec spec, List<Animator> animations, List<AnimatorListener> list, RectF childBounds) {
        ...
        if (z) {
            ...
            translationYTiming = translationYTiming2;
            translationXTiming = translationXTiming2;
            Pair pair2 = motionTiming;
            float translationY3 = translationY;
            float translationX2 = translationX;
            ValueAnimator translationXAnimator3 = ObjectAnimator.ofFloat(view2, View.TRANSLATION_X, new float[]{-translationX2});
            translationXAnimator = translationXAnimator3;
            translationYAnimator = ObjectAnimator.ofFloat(view2, View.TRANSLATION_Y, new float[]{-translationY3});
        }
        translationXTiming.apply(translationXAnimator);
        translationYTiming.apply(translationYAnimator);
    ...
    private ViewGroup calculateChildContentContainer(View view) {
        View childContentContainer = view.findViewById(C1124R.C1127id.mtrl_child_content_container);
        if (childContentContainer != null) {
