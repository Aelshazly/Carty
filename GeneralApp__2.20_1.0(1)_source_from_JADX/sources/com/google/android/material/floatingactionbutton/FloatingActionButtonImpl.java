...
class FloatingActionButtonImpl {
    ...
    private MotionSpec getDefaultShowMotionSpec() {
        if (this.defaultShowMotionSpec == null) {
            this.defaultShowMotionSpec = MotionSpec.createFromResource(this.view.getContext(), C1124R.animator.design_fab_show_motion_spec);
        }
    ...
    private MotionSpec getDefaultHideMotionSpec() {
        if (this.defaultHideMotionSpec == null) {
            this.defaultHideMotionSpec = MotionSpec.createFromResource(this.view.getContext(), C1124R.animator.design_fab_hide_motion_spec);
        }
    ...
    private AnimatorSet createAnimator(MotionSpec spec, float opacity, float scale, float iconScale) {
        ...
        String str = "scale";
        spec.getTiming(str).apply(animatorScaleX);
        ...
        spec.getTiming(str).apply(animatorScaleY);
