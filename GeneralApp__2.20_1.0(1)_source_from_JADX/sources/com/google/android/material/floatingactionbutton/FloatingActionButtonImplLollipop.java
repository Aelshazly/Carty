...
class FloatingActionButtonImplLollipop extends FloatingActionButtonImpl {
    ...
    public void initializeBackgroundDrawable(ColorStateList backgroundTint, Mode backgroundTintMode, ColorStateList rippleColor, int borderWidth) {
    ...
    public BorderDrawable createBorderDrawable(int borderWidth, ColorStateList backgroundTint) {
        ...
        borderDrawable.setGradientColors(ContextCompat.getColor(context, C1124R.C1125color.design_fab_stroke_top_outer_color), ContextCompat.getColor(context, C1124R.C1125color.design_fab_stroke_top_inner_color), ContextCompat.getColor(context, C1124R.C1125color.design_fab_stroke_end_inner_color), ContextCompat.getColor(context, C1124R.C1125color.design_fab_stroke_end_outer_color));
