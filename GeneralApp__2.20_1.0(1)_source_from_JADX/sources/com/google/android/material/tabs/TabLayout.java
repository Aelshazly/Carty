...
public class TabLayout extends HorizontalScrollView {
    ...
    private class SlidingTabIndicator extends LinearLayout {
        ...
        public void animateIndicatorToPosition(int position, int duration) {
            ...
            if (startLeft == finalTargetLeft && startRight == finalTargetRight) {
                ...
                C06811 r0 = new AnimatorUpdateListener() {
    ...
    public final class TabView extends LinearLayout {
        ...
        public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
            ...
            if (badgeDrawable2 != null && badgeDrawable2.isVisible()) {
                ...
                sb.append(customContentDescription);
                sb.append(", ");
        ...
        private void inflateAndAddDefaultIconView() {
            ...
            if (BadgeUtils.USE_COMPAT_PARENT) {
                ViewGroup iconViewParent2 = createPreApi18BadgeAnchorRoot();
                addView(iconViewParent2, 0);
                iconViewParent = iconViewParent2;
            }
            this.iconView = (ImageView) LayoutInflater.from(getContext()).inflate(C1124R.layout.design_layout_tab_icon, iconViewParent, false);
        ...
        private void inflateAndAddDefaultTextView() {
            ...
            if (BadgeUtils.USE_COMPAT_PARENT) {
                ViewGroup textViewParent2 = createPreApi18BadgeAnchorRoot();
                addView(textViewParent2);
                textViewParent = textViewParent2;
            }
            this.textView = (TextView) LayoutInflater.from(getContext()).inflate(C1124R.layout.design_layout_tab_text, textViewParent, false);
        ...
        private FrameLayout getCustomParentForBadge(View anchor) {
            ...
            if (BadgeUtils.USE_COMPAT_PARENT) {
                frameLayout = (FrameLayout) anchor.getParent();
            }
            return frameLayout;
        }
    ...
    public TabLayout(Context context, AttributeSet attrs) {
        this(context, attrs, C1124R.attr.tabStyle);
    }
    ...
    public TabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = ThemeEnforcement.obtainStyledAttributes(context, attrs, C1124R.styleable.TabLayout, defStyleAttr, C1124R.style.Widget_Design_TabLayout, C1124R.styleable.TabLayout_tabTextAppearance);
        ...
        this.slidingTabIndicator.setSelectedIndicatorHeight(a.getDimensionPixelSize(C1124R.styleable.TabLayout_tabIndicatorHeight, -1));
        this.slidingTabIndicator.setSelectedIndicatorColor(a.getColor(C1124R.styleable.TabLayout_tabIndicatorColor, 0));
        setSelectedTabIndicator(MaterialResources.getDrawable(context, a, C1124R.styleable.TabLayout_tabIndicator));
        setSelectedTabIndicatorGravity(a.getInt(C1124R.styleable.TabLayout_tabIndicatorGravity, 0));
        setTabIndicatorFullWidth(a.getBoolean(C1124R.styleable.TabLayout_tabIndicatorFullWidth, true));
        int dimensionPixelSize = a.getDimensionPixelSize(C1124R.styleable.TabLayout_tabPadding, 0);
        this.tabPaddingBottom = dimensionPixelSize;
        this.tabPaddingEnd = dimensionPixelSize;
        this.tabPaddingTop = dimensionPixelSize;
        this.tabPaddingStart = dimensionPixelSize;
        this.tabPaddingStart = a.getDimensionPixelSize(C1124R.styleable.TabLayout_tabPaddingStart, this.tabPaddingStart);
        this.tabPaddingTop = a.getDimensionPixelSize(C1124R.styleable.TabLayout_tabPaddingTop, this.tabPaddingTop);
        this.tabPaddingEnd = a.getDimensionPixelSize(C1124R.styleable.TabLayout_tabPaddingEnd, this.tabPaddingEnd);
        this.tabPaddingBottom = a.getDimensionPixelSize(C1124R.styleable.TabLayout_tabPaddingBottom, this.tabPaddingBottom);
        this.tabTextAppearance = a.getResourceId(C1124R.styleable.TabLayout_tabTextAppearance, C1124R.style.TextAppearance_Design_Tab);
        TypedArray ta = context.obtainStyledAttributes(this.tabTextAppearance, C0980R.styleable.TextAppearance);
        try {
            this.tabTextSize = (float) ta.getDimensionPixelSize(C0980R.styleable.TextAppearance_android_textSize, 0);
            this.tabTextColors = MaterialResources.getColorStateList(context, ta, C0980R.styleable.TextAppearance_android_textColor);
            ta.recycle();
            if (a.hasValue(C1124R.styleable.TabLayout_tabTextColor)) {
                this.tabTextColors = MaterialResources.getColorStateList(context, a, C1124R.styleable.TabLayout_tabTextColor);
            }
            if (a.hasValue(C1124R.styleable.TabLayout_tabSelectedTextColor)) {
                this.tabTextColors = createColorStateList(this.tabTextColors.getDefaultColor(), a.getColor(C1124R.styleable.TabLayout_tabSelectedTextColor, 0));
            }
            this.tabIconTint = MaterialResources.getColorStateList(context, a, C1124R.styleable.TabLayout_tabIconTint);
            this.tabIconTintMode = ViewUtils.parseTintMode(a.getInt(C1124R.styleable.TabLayout_tabIconTintMode, -1), null);
            this.tabRippleColorStateList = MaterialResources.getColorStateList(context, a, C1124R.styleable.TabLayout_tabRippleColor);
            this.tabIndicatorAnimationDuration = a.getInt(C1124R.styleable.TabLayout_tabIndicatorAnimationDuration, 300);
            this.requestedTabMinWidth = a.getDimensionPixelSize(C1124R.styleable.TabLayout_tabMinWidth, -1);
            this.requestedTabMaxWidth = a.getDimensionPixelSize(C1124R.styleable.TabLayout_tabMaxWidth, -1);
            this.tabBackgroundResId = a.getResourceId(C1124R.styleable.TabLayout_tabBackground, 0);
            this.contentInsetStart = a.getDimensionPixelSize(C1124R.styleable.TabLayout_tabContentStart, 0);
            this.mode = a.getInt(C1124R.styleable.TabLayout_tabMode, 1);
            this.tabGravity = a.getInt(C1124R.styleable.TabLayout_tabGravity, 0);
            this.inlineLabel = a.getBoolean(C1124R.styleable.TabLayout_tabInlineLabel, false);
            this.unboundedRipple = a.getBoolean(C1124R.styleable.TabLayout_tabUnboundedRipple, false);
            a.recycle();
            Resources res = getResources();
            this.tabTextMultiLineSize = (float) res.getDimensionPixelSize(C1124R.dimen.design_tab_text_size_2line);
            this.scrollableTabMinWidth = res.getDimensionPixelSize(C1124R.dimen.design_tab_scrollable_min_width);
            applyModeAndGravity();
        } catch (Throwable th) {
            ta.recycle();
            throw th;
