...
final class IndicatorViewController {
    ...
    private final float captionTranslationYPx = ((float) this.context.getResources().getDimensionPixelSize(C1124R.dimen.design_textinput_caption_translate_y));
    ...
    private void updateCaptionViewsVisibility(int captionToHide, int captionToShow2, boolean animate) {
        ...
        if (z) {
            ...
            C07011 r0 = new AnimatorListenerAdapter() {
    ...
    public void setErrorEnabled(boolean enabled) {
        if (this.errorEnabled != enabled) {
            ...
            if (enabled) {
                ...
                this.errorView.setId(C1124R.C1127id.textinput_error);
    ...
    public void setHelperTextEnabled(boolean enabled) {
        if (this.helperTextEnabled != enabled) {
            ...
            if (enabled) {
                ...
                this.helperTextView.setId(C1124R.C1127id.textinput_helper_text);
                Typeface typeface2 = this.typeface;
                if (typeface2 != null) {
