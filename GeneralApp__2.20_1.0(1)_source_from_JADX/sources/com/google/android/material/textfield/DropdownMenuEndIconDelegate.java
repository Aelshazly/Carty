...
class DropdownMenuEndIconDelegate extends EndIconDelegate {
    ...
    public void initialize() {
        float popupCornerRadius = (float) this.context.getResources().getDimensionPixelOffset(C1124R.dimen.mtrl_shape_corner_size_small_component);
        float exposedDropdownPopupElevation = (float) this.context.getResources().getDimensionPixelOffset(C1124R.dimen.mtrl_exposed_dropdown_menu_popup_elevation);
        int exposedDropdownPopupVerticalPadding = this.context.getResources().getDimensionPixelOffset(C1124R.dimen.mtrl_exposed_dropdown_menu_popup_vertical_padding);
        ...
        this.filledPopupBackground.addState(new int[]{16842922}, roundedCornersPopupBackground);
        this.filledPopupBackground.addState(new int[0], roundedBottomCornersPopupBackground);
        this.textInputLayout.setEndIconDrawable(AppCompatResources.getDrawable(this.context, IS_LOLLIPOP ? C1124R.C1126drawable.mtrl_dropdown_arrow : C1124R.C1126drawable.mtrl_ic_arrow_drop_down));
        this.textInputLayout.setEndIconContentDescription(this.textInputLayout.getResources().getText(C1124R.string.exposed_dropdown_menu_content_description));
    ...
    public void addRippleEffect(AutoCompleteTextView editText) {
        if (editText.getKeyListener() == null) {
            ...
            int rippleColor = MaterialColors.getColor(editText, C1124R.attr.colorControlHighlight);
    ...
    private void addRippleEffectOnOutlinedLayout(AutoCompleteTextView editText, int rippleColor, int[][] states, MaterialShapeDrawable boxBackground) {
        ...
        int surfaceColor = MaterialColors.getColor(editText, C1124R.attr.colorSurface);
    ...
    public void setUpDropdownShowHideBehavior(final AutoCompleteTextView editText) {
        ...
        if (IS_LOLLIPOP) {
            editText.setOnDismissListener(new OnDismissListener() {
