...
public class Snackbar extends BaseTransientBottomBar<Snackbar> {
    private static final int[] SNACKBAR_BUTTON_STYLE_ATTR = {C1124R.attr.snackbarButtonStyle};
    ...
    public static Snackbar make(View view, CharSequence text, int duration) {
        ...
        if (parent != null) {
            SnackbarContentLayout content = (SnackbarContentLayout) LayoutInflater.from(parent.getContext()).inflate(hasSnackbarButtonStyleAttr(parent.getContext()) ? C1124R.layout.mtrl_layout_snackbar_include : C1124R.layout.design_layout_snackbar_include, parent, false);
    ...
    public Snackbar setBackgroundTint(int color) {
        ...
        if (background != null) {
            ...
            if (VERSION.SDK_INT >= 22) {
                ...
                background2.setColorFilter(color, Mode.SRC_IN);
            }
        }
        return this;
    }
