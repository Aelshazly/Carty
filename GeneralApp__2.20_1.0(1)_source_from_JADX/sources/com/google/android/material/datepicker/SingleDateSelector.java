...
public class SingleDateSelector implements DateSelector<Long> {
    ...
    public View onCreateTextInputView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle, CalendarConstraints constraints, OnSelectionChangedListener<Long> listener) {
        View root = layoutInflater.inflate(C1124R.layout.mtrl_picker_text_input_date, viewGroup, false);
        TextInputLayout dateTextInput = (TextInputLayout) root.findViewById(C1124R.C1127id.mtrl_picker_text_input_date);
        ...
        C06151 r4 = new DateFormatTextWatcher(formatHint, format, dateTextInput, constraints) {
        ...
        dateEditText.addTextChangedListener(r4);
        ViewUtils.requestFocusAndShowKeyboard(dateEditText);
        return root;
    }

    public int getDefaultThemeResId(Context context) {
        return MaterialAttributes.resolveOrThrow(context, C1124R.attr.materialCalendarTheme, MaterialDatePicker.class.getCanonicalName());
    }
    ...
    public String getSelectionDisplayString(Context context) {
        ...
        Long l = this.selectedItem;
        if (l == null) {
            return res.getString(C1124R.string.mtrl_picker_date_header_unselected);
        }
        String startString = DateStrings.getYearMonthDay(l.longValue());
        return res.getString(C1124R.string.mtrl_picker_date_header_selected, new Object[]{startString});
    }

    public int getDefaultTitleResId() {
        return C1124R.string.mtrl_picker_date_header_title;
    }
