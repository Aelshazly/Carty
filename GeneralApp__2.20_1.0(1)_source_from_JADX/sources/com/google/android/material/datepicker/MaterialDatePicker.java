...
public final class MaterialDatePicker<S> extends DialogFragment {
    ...
    public final void onSaveInstanceState(Bundle bundle) {
        ...
        com.google.android.material.datepicker.CalendarConstraints.Builder constraintsBuilder = new com.google.android.material.datepicker.CalendarConstraints.Builder(this.calendarConstraints);
    ...
    public final Dialog onCreateDialog(Bundle bundle) {
        ...
        int surfaceColor = MaterialAttributes.resolveOrThrow(context, C1124R.attr.colorSurface, MaterialDatePicker.class.getCanonicalName());
        this.background = new MaterialShapeDrawable(context, null, C1124R.attr.materialCalendarStyle, C1124R.style.Widget_MaterialComponents_MaterialCalendar);
    ...
    public final View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        View root = layoutInflater.inflate(this.fullscreen ? C1124R.layout.mtrl_picker_fullscreen : C1124R.layout.mtrl_picker_dialog, viewGroup);
        Context context = root.getContext();
        if (this.fullscreen) {
            root.findViewById(C1124R.C1127id.mtrl_calendar_frame).setLayoutParams(new LayoutParams(getPaddedPickerWidth(context), -2));
        } else {
            View pane = root.findViewById(C1124R.C1127id.mtrl_calendar_main_pane);
            View frame = root.findViewById(C1124R.C1127id.mtrl_calendar_frame);
            pane.setLayoutParams(new LayoutParams(getPaddedPickerWidth(context), -1));
            frame.setMinimumHeight(getDialogPickerHeight(requireContext()));
        }
        this.headerSelectionText = (TextView) root.findViewById(C1124R.C1127id.mtrl_picker_header_selection_text);
        ViewCompat.setAccessibilityLiveRegion(this.headerSelectionText, 1);
        this.headerToggleButton = (CheckableImageButton) root.findViewById(C1124R.C1127id.mtrl_picker_header_toggle);
        TextView titleTextView = (TextView) root.findViewById(C1124R.C1127id.mtrl_picker_title_text);
        ...
        this.confirmButton = (Button) root.findViewById(C1124R.C1127id.confirm_button);
        ...
        Button cancelButton = (Button) root.findViewById(C1124R.C1127id.cancel_button);
    ...
    public void onStart() {
        ...
        if (this.fullscreen) {
            ...
            int inset = getResources().getDimensionPixelOffset(C1124R.dimen.mtrl_calendar_dialog_background_inset);
            Rect insets = new Rect(inset, inset, inset, inset);
            InsetDrawable insetDrawable = new InsetDrawable(this.background, inset, inset, inset, inset);
    ...
    public void updateHeader() {
        ...
        this.headerSelectionText.setContentDescription(String.format(getString(C1124R.string.mtrl_picker_announce_current_selection), new Object[]{headerText}));
    ...
    public void startPickerFragment() {
        ...
        fragmentTransaction.replace(C1124R.C1127id.mtrl_calendar_frame, this.pickerFragment);
    ...
    public void updateToggleContentDescription(CheckableImageButton toggle) {
        ...
        if (this.headerToggleButton.isChecked()) {
            contentDescription = toggle.getContext().getString(C1124R.string.mtrl_picker_toggle_to_calendar_input_mode);
        } else {
            contentDescription = toggle.getContext().getString(C1124R.string.mtrl_picker_toggle_to_text_input_mode);
        }
    ...
    private static Drawable createHeaderToggleDrawable(Context context) {
        ...
        toggleDrawable.addState(new int[]{16842912}, AppCompatResources.getDrawable(context, C1124R.C1126drawable.ic_calendar_black_24dp));
        toggleDrawable.addState(new int[0], AppCompatResources.getDrawable(context, C1124R.C1126drawable.ic_edit_black_24dp));
        return toggleDrawable;
    }

    static boolean isFullscreen(Context context) {
        TypedArray a = context.obtainStyledAttributes(MaterialAttributes.resolveOrThrow(context, C1124R.attr.materialCalendarStyle, MaterialCalendar.class.getCanonicalName()), new int[]{16843277});
    ...
    private static int getDialogPickerHeight(Context context) {
        ...
        int calendarHeight = (MonthAdapter.MAXIMUM_WEEKS * resources.getDimensionPixelSize(C1124R.dimen.mtrl_calendar_day_height)) + ((MonthAdapter.MAXIMUM_WEEKS - 1) * resources.getDimensionPixelOffset(C1124R.dimen.mtrl_calendar_month_vertical_padding));
        return resources.getDimensionPixelSize(C1124R.dimen.mtrl_calendar_navigation_height) + resources.getDimensionPixelOffset(C1124R.dimen.mtrl_calendar_navigation_top_padding) + resources.getDimensionPixelOffset(C1124R.dimen.mtrl_calendar_navigation_bottom_padding) + resources.getDimensionPixelSize(C1124R.dimen.mtrl_calendar_days_of_week_height) + calendarHeight + resources.getDimensionPixelOffset(C1124R.dimen.mtrl_calendar_bottom_padding);
    }

    private static int getPaddedPickerWidth(Context context) {
        Resources resources = context.getResources();
        int padding = resources.getDimensionPixelOffset(C1124R.dimen.mtrl_calendar_content_padding);
        int daysInWeek = Month.today().daysInWeek;
        return (padding * 2) + (daysInWeek * resources.getDimensionPixelSize(C1124R.dimen.mtrl_calendar_day_width)) + ((daysInWeek - 1) * resources.getDimensionPixelOffset(C1124R.dimen.mtrl_calendar_month_horizontal_padding));
    }
    ...
    public boolean addOnNegativeButtonClickListener(OnClickListener onNegativeButtonClickListener) {
        return this.onNegativeButtonClickListeners.add(onNegativeButtonClickListener);
    }

    public boolean removeOnNegativeButtonClickListener(OnClickListener onNegativeButtonClickListener) {
