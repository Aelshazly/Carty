...
public final class MaterialCalendar<S> extends PickerFragment<S> {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        if (MaterialDatePicker.isFullscreen(themedContext)) {
            layout = C1124R.layout.mtrl_calendar_vertical;
            orientation = 1;
        } else {
            layout = C1124R.layout.mtrl_calendar_horizontal;
            orientation = 0;
        }
        View root = themedInflater.inflate(layout, viewGroup, false);
        GridView daysHeader = (GridView) root.findViewById(C1124R.C1127id.mtrl_calendar_days_of_week);
        ...
        this.recyclerView = (RecyclerView) root.findViewById(C1124R.C1127id.mtrl_calendar_months);
        GridView gridView = daysHeader;
        final int i = orientation;
        C05962 r0 = new SmoothCalendarLayoutManager(getContext(), orientation, false) {
            /* access modifiers changed from: protected */
            public void calculateExtraLayoutSpace(State state, int[] ints) {
                if (i == 0) {
        ...
        int columns = themedContext.getResources().getInteger(C1124R.integer.mtrl_calendar_year_selector_span);
        this.yearSelector = (RecyclerView) root.findViewById(C1124R.C1127id.mtrl_calendar_year_selector_frame);
        ...
        if (root.findViewById(C1124R.C1127id.month_navigation_fragment_toggle) != null) {
        ...
        return new ItemDecoration() {
            ...
            public void onDraw(Canvas canvas, RecyclerView recyclerView, State state) {
                ...
                if ((recyclerView.getAdapter() instanceof YearGridAdapter) && (recyclerView.getLayoutManager() instanceof GridLayoutManager)) {
                    ...
                    Iterator it2 = MaterialCalendar.this.dateSelector.getSelectedRanges().iterator();
                    while (it2.hasNext()) {
                        ...
                        if (pair2.first == null) {
                            ...
                            this.startItem.setTimeInMillis(((Long) pair2.first).longValue());
                            this.endItem.setTimeInMillis(((Long) pair2.second).longValue());
    ...
    static int getDayHeight(Context context) {
        return context.getResources().getDimensionPixelSize(C1124R.dimen.mtrl_calendar_day_height);
    }
    ...
    private void addActionsToMonthNavigation(View root, final MonthsPagerAdapter monthsPagerAdapter) {
        final MaterialButton monthDropSelect = (MaterialButton) root.findViewById(C1124R.C1127id.month_navigation_fragment_toggle);
        ...
        ViewCompat.setAccessibilityDelegate(monthDropSelect, new AccessibilityDelegateCompat() {
            public void onInitializeAccessibilityNodeInfo(View view, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
                ...
                if (MaterialCalendar.this.dayFrame.getVisibility() == 0) {
                    str = MaterialCalendar.this.getString(C1124R.string.mtrl_picker_toggle_to_year_selection);
                } else {
                    str = MaterialCalendar.this.getString(C1124R.string.mtrl_picker_toggle_to_day_selection);
                }
                accessibilityNodeInfoCompat.setHintText(str);
            }
        });
        MaterialButton monthPrev = (MaterialButton) root.findViewById(C1124R.C1127id.month_navigation_previous);
        monthPrev.setTag(NAVIGATION_PREV_TAG);
        MaterialButton monthNext = (MaterialButton) root.findViewById(C1124R.C1127id.month_navigation_next);
        monthNext.setTag(NAVIGATION_NEXT_TAG);
        this.yearFrame = root.findViewById(C1124R.C1127id.mtrl_calendar_year_selector_frame);
        this.dayFrame = root.findViewById(C1124R.C1127id.mtrl_calendar_day_selector_frame);
        setSelector(CalendarSelector.DAY);
        ...
        monthDropSelect.setOnClickListener(new OnClickListener() {
