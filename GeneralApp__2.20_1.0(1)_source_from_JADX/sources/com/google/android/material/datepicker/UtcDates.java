...
class UtcDates {
    ...
    static String getTextInputHint(Resources res, SimpleDateFormat format) {
        ...
        return formatHint.replaceAll("d", res.getString(C1124R.string.mtrl_picker_text_input_day_abbr)).replaceAll("M", res.getString(C1124R.string.mtrl_picker_text_input_month_abbr)).replaceAll("y", res.getString(C1124R.string.mtrl_picker_text_input_year_abbr));
    }
    ...
    private static String removeYearFromDateFormatPattern(String pattern) {
        ...
        if (yearEndPosition < pattern.length()) {
            ...
            sb.append(monthDayCharacters);
            sb.append(",");
            monthDayCharacters = sb.toString();
        }
