...
public class ChildrenAlphaProperty extends Property<ViewGroup, Float> {
    ...
    public Float get(ViewGroup object) {
        Float alpha = (Float) object.getTag(C1124R.C1127id.mtrl_internal_children_alpha_tag);
        if (alpha != null) {
            return alpha;
        }
    ...
    public void set(ViewGroup object, Float value) {
        ...
        object.setTag(C1124R.C1127id.mtrl_internal_children_alpha_tag, Float.valueOf(alpha));
