...
public class BottomNavigationItemView extends FrameLayout implements ItemView {
    ...
    public BottomNavigationItemView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        LayoutInflater.from(context).inflate(C1124R.layout.design_bottom_navigation_item, this, true);
        setBackgroundResource(C1124R.C1126drawable.design_bottom_navigation_item_background);
        this.defaultMargin = res.getDimensionPixelSize(C1124R.dimen.design_bottom_navigation_margin);
        this.icon = (ImageView) findViewById(C1124R.C1127id.icon);
        this.smallLabel = (TextView) findViewById(C1124R.C1127id.smallLabel);
        this.largeLabel = (TextView) findViewById(C1124R.C1127id.largeLabel);
