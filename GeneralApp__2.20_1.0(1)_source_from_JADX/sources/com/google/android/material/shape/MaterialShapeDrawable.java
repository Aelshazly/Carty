...
public class MaterialShapeDrawable extends Drawable implements TintAwareDrawable, Shapeable {
    ...
    public static MaterialShapeDrawable createWithElevationOverlay(Context context, float elevation) {
        int colorSurface = MaterialColors.getColor(context, C1124R.attr.colorSurface, MaterialShapeDrawable.class.getSimpleName());
    ...
    public void draw(Canvas canvas) {
        ...
        if (hasCompatShadow()) {
            ...
            Bitmap shadowLayer = Bitmap.createBitmap(((int) this.pathBounds.width()) + (this.drawableState.shadowCompatRadius * 2) + pathExtraWidth, ((int) this.pathBounds.height()) + (this.drawableState.shadowCompatRadius * 2) + pathExtraHeight, Config.ARGB_8888);
    ...
    private void calculateStrokePath() {
        ...
        this.strokeShapeAppearance = getShapeAppearanceModel().withTransformedCornerSizes(new CornerSizeUnaryOperator() {
    ...
    private PorterDuffColorFilter calculateTintFilter(ColorStateList tintList, Mode tintMode, Paint paint, boolean requiresElevationOverlay) {
    ...
    private PorterDuffColorFilter calculateTintColorTintFilter(ColorStateList tintList, Mode tintMode, boolean requiresElevationOverlay) {
    ...
    private boolean updateColorsForState(int[] state) {
        ...
        if (this.drawableState.fillColor != null) {
            ...
            int newFillColor = this.drawableState.fillColor.getColorForState(state, previousFillColor);
        ...
        int newStrokeColor = this.drawableState.strokeColor.getColorForState(state, previousStrokeColor);
