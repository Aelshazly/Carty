...
public final class MonochromeRectangleDetector {
    ...
    public ResultPoint[] detect() throws NotFoundException {
        ...
        int left = ((int) findCornerFromCenter.getX()) - 1;
        int i5 = left;
        ResultPoint findCornerFromCenter2 = findCornerFromCenter(halfWidth, deltaX4, i5, i2, i3, 0, i4, deltaX2, halfHeight / 2);
        ResultPoint pointC = findCornerFromCenter2;
        int right = ((int) findCornerFromCenter2.getX()) + 1;
        int i6 = right;
        ResultPoint findCornerFromCenter3 = findCornerFromCenter(halfWidth, 0, i5, i6, i3, deltaY2, i4, deltaX2, halfWidth / 2);
        ResultPoint pointD = findCornerFromCenter3;
        int bottom = ((int) findCornerFromCenter3.getY()) + 1;
        int deltaY3 = deltaY2;
        int i7 = deltaY3;
        return new ResultPoint[]{findCornerFromCenter(halfWidth, 0, i5, i6, i3, -deltaY3, i4, bottom, halfWidth / 4), pointB, pointC, pointD};
    }
