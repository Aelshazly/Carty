...
public final class PDF417 {
    ...
    public void generateBarcodeLogic(String msg, int errorCorrectionLevel) throws WriterException {
        ...
        int[] determineDimensions = determineDimensions(sourceCodeWords, errorCorrectionCodeWords);
        int[] dimension = determineDimensions;
        int cols = determineDimensions[0];
        ...
        if (sourceCodeWords + errorCorrectionCodeWords + 1 <= 929) {
            ...
            sb4.append(dataCodewords);
            sb4.append(ec);
            String str = ec;
            String str2 = dataCodewords;
            StringBuilder sb5 = sb2;
            encodeLowLevel(sb4.toString(), cols, rows, errorCorrectionLevel, this.barcodeMatrix);
            return;
        }
        StringBuilder sb6 = new StringBuilder("Encoded message contains too many code words, message too big (");
        sb6.append(msg.length());
        sb6.append(" bytes)");
        throw new WriterException(sb6.toString());
    }
    ...
    private int[] determineDimensions(int sourceCodeWords, int errorCorrectionCodeWords) throws WriterException {
        ...
        for (int cols = this.minCols; cols <= this.maxCols; cols++) {
            int calculateNumberOfRows = calculateNumberOfRows(sourceCodeWords, errorCorrectionCodeWords, cols);
        ...
        if (dimension == null) {
            int calculateNumberOfRows2 = calculateNumberOfRows(sourceCodeWords, errorCorrectionCodeWords, this.minCols);
            int i = this.minRows;
            if (calculateNumberOfRows2 < i) {
