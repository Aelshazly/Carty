    ...
    public EmailAddressParsedResult parse(Result result) {
        ...
        if (massagedText.startsWith("mailto:") || rawText.startsWith("MAILTO:")) {
            ...
            try {
                ...
                if (nameValues != null) {
                    if (tos == null) {
                        String str = (String) nameValues.get("to");
                        String tosString = str;
                        if (str != null) {
                            tos = COMMA.split(tosString);
                        }
                    }
                    String str2 = (String) nameValues.get("cc");
                    String ccString = str2;
                    if (str2 != null) {
                        ccs = COMMA.split(ccString);
                    }
                    String str3 = (String) nameValues.get("bcc");
                ...
                EmailAddressParsedResult emailAddressParsedResult = new EmailAddressParsedResult(tos, ccs, bccs, subject, body);
