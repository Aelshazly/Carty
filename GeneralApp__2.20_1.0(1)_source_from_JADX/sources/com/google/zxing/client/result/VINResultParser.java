...
public final class VINResultParser extends ResultParser {
    ...
    public VINParsedResult parse(Result result) {
        ...
        try {
            ...
            try {
                VINParsedResult vINParsedResult = new VINParsedResult(rawText, wmi, rawText.substring(3, 9), rawText.substring(9, 17), countryCode(wmi), rawText.substring(3, 8), modelYear(rawText.charAt(9)), rawText.charAt(10), rawText.substring(11));
