...
public final class HighLevelEncoder {
    ...
    public static String encodeHighLevel(String msg, SymbolShapeHint shape, Dimension minSize, Dimension maxSize) {
        ...
        boolean startsWith = msg.startsWith(MACRO_05_HEADER);
        String str = MACRO_TRAILER;
        if (startsWith && msg.endsWith(str)) {
            context.writeCodeword(MACRO_05);
            context.setSkipAtEnd(2);
            context.pos += 7;
        } else if (msg.startsWith(MACRO_06_HEADER) && msg.endsWith(str)) {
