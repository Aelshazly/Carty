    ...
    public byte[] readCodewords() throws FormatException {
        ...
        while (true) {
            if (row == numRows && column == 0 && !corner1Read) {
                ...
                int resultOffset3 = resultOffset + 1;
