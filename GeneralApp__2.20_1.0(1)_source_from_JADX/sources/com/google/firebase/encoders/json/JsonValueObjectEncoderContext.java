...
final class JsonValueObjectEncoderContext implements ObjectEncoderContext, ValueEncoderContext {
    ...
    public JsonValueObjectEncoderContext add(Object o, boolean inline) throws IOException {
        ...
        if (inline && cannotBeInline(o)) {
            ...
            ObjectEncoder<Object> objectEncoder = (ObjectEncoder) this.objectEncoders.get(o.getClass());
            if (objectEncoder != null) {
                return doEncode(objectEncoder, o, inline);
            }
            ValueEncoder<Object> valueEncoder = (ValueEncoder) this.valueEncoders.get(o.getClass());
