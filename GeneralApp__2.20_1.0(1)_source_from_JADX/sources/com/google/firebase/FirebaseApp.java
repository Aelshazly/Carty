...
public class FirebaseApp {
    ...
    public static FirebaseApp getInstance() {
        ...
        synchronized (LOCK) {
            defaultApp = (FirebaseApp) INSTANCES.get(DEFAULT_APP_NAME);
            if (defaultApp == null) {
        ...
        synchronized (LOCK) {
            ...
            if (firebaseApp == null) {
                ...
                if (availableAppNames.isEmpty()) {
                    ...
                    sb.append(TextUtils.join(", ", availableAppNames));
                    availableAppNamesMessage = sb.toString();
                }
    ...
    protected FirebaseApp(Context applicationContext2, String name2, FirebaseOptions options2) {
        ...
        componentArr[0] = Component.m70of(applicationContext2, Context.class, new Class[0]);
        componentArr[1] = Component.m70of(this, FirebaseApp.class, new Class[0]);
        componentArr[2] = Component.m70of(options2, FirebaseOptions.class, new Class[0]);
    ...
    public static String getPersistenceKey(String name2, FirebaseOptions options2) {
        StringBuilder sb = new StringBuilder();
        sb.append(Base64Utils.encodeUrlSafeNoPadding(name2.getBytes(Charset.defaultCharset())));
        sb.append("+");
        sb.append(Base64Utils.encodeUrlSafeNoPadding(options2.getApplicationId().getBytes(Charset.defaultCharset())));
        return sb.toString();
    }
