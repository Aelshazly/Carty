...
class EventBus implements Subscriber, Publisher {
    ...
    public void publish(com.google.firebase.events.Event<?> r6) {
        /*
            ...
            monitor-enter(r5)
            java.util.Queue<com.google.firebase.events.Event<?>> r0 = r5.pendingEvents     // Catch:{ all -> 0x0034 }
            if (r0 == 0) goto L_0x000f
            java.util.Queue<com.google.firebase.events.Event<?>> r0 = r5.pendingEvents     // Catch:{ all -> 0x0034 }
            r0.add(r6)     // Catch:{ all -> 0x0034 }
    ...
    private synchronized Set<Entry<EventHandler<Object>, Executor>> getHandlers(Event<?> event) {
        ...
        handlers = (Map) this.handlerMap.get(event.getType());
    ...
    public synchronized <T> void subscribe(Class<T> type, Executor executor, EventHandler<? super T> handler) {
        ...
        ((ConcurrentHashMap) this.handlerMap.get(type)).put(handler, executor);
    }
