...
public final class Component<T> {
    ...
    @Deprecated
    /* renamed from: of */
    public static <T> Component<T> m69of(Class<T> anInterface, T value) {
    ...
    @SafeVarargs
    /* renamed from: of */
    public static <T> Component<T> m70of(T value, Class<T> anInterface, Class<? super T>... additionalInterfaces) {
