...
public class CrashlyticsRegistrar implements ComponentRegistrar {
    ...
    public FirebaseCrashlytics buildCrashlytics(ComponentContainer container) {
        return FirebaseCrashlytics.init((FirebaseApp) container.get(FirebaseApp.class), (FirebaseInstanceIdInternal) container.getProvider(FirebaseInstanceIdInternal.class).get(), (CrashlyticsNativeComponent) container.get(CrashlyticsNativeComponent.class), (AnalyticsConnector) container.get(AnalyticsConnector.class));
    }
}
