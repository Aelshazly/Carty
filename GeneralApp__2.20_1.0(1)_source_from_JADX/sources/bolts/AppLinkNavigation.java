...
public class AppLinkNavigation {
    ...
    public NavigationResult navigate(Context context) {
        ...
        while (true) {
            ...
            Intent targetIntent = new Intent(str2);
            ...
            targetIntent.putExtra(str, finalAppLinkData);
        ...
        if (eligibleTargetIntent != null) {
            ...
            if (webUrl != null) {
                try {
                    outIntent = new Intent(str2, webUrl.buildUpon().appendQueryParameter(str, getJSONForBundle(finalAppLinkData).toString()).build());
    ...
    private void sendAppLinkNavigateEventBroadcast(Context context, Intent intent, NavigationResult type, JSONException e) {
        ...
        extraLoggingData.put(Param.SUCCESS, type.isSucceeded() ? DiskLruCache.VERSION_1 : "0");
