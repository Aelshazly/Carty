...
public final class DurationKt {
    ...
    public static final double toDuration(double $this$toDuration, TimeUnit unit) {
        Intrinsics.checkParameterIsNotNull(unit, "unit");
        return Duration.m2191constructorimpl(DurationUnitKt.convertDurationUnit($this$toDuration, unit, TimeUnit.NANOSECONDS));
    }
    ...
    private static final double m2236timesmvk6XK0(int $this$times, double duration) {
        return Duration.m2218timesimpl(duration, $this$times);
    }

    /* renamed from: times-kIfJnKk reason: not valid java name */
    private static final double m2235timeskIfJnKk(double $this$times, double duration) {
        return Duration.m2217timesimpl(duration, $this$times);
    }
}
