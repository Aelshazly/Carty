        ...
        while (true) {
            ...
            try {
                ...
                if (outcome != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                    ...
                    obj = Result.m1266constructorimpl(outcome);
                    Object outcome2 = obj;
                ...
                obj = Result.m1266constructorimpl(ResultKt.createFailure(exception));
            }
        }
    }
