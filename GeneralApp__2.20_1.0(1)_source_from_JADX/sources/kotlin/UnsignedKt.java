...
@Metadata(mo24950bv = {1, 0, 3}, mo24951d1 = {"\u00000\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0006\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\t\n\u0002\u0010\t\n\u0002\b\u0007\n\u0002\u0010\u000e\n\u0002\b\u0002\u001a\u0018\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u0003H\u0001ø\u0001\u0000¢\u0006\u0002\u0010\u0004\u001a\u0018\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0002\u001a\u00020\u0003H\u0001ø\u0001\u0000¢\u0006\u0002\u0010\u0007\u001a\u0018\u0010\b\u001a\u00020\t2\u0006\u0010\n\u001a\u00020\t2\u0006\u0010\u000b\u001a\u00020\tH\u0001\u001a\"\u0010\f\u001a\u00020\u00012\u0006\u0010\n\u001a\u00020\u00012\u0006\u0010\u000b\u001a\u00020\u0001H\u0001ø\u0001\u0000¢\u0006\u0004\b\r\u0010\u000e\u001a\"\u0010\u000f\u001a\u00020\u00012\u0006\u0010\n\u001a\u00020\u00012\u0006\u0010\u000b\u001a\u00020\u0001H\u0001ø\u0001\u0000¢\u0006\u0004\b\u0010\u0010\u000e\u001a\u0010\u0010\u0011\u001a\u00020\u00032\u0006\u0010\u0002\u001a\u00020\tH\u0001\u001a\u0018\u0010\u0012\u001a\u00020\t2\u0006\u0010\n\u001a\u00020\u00132\u0006\u0010\u000b\u001a\u00020\u0013H\u0001\u001a\"\u0010\u0014\u001a\u00020\u00062\u0006\u0010\n\u001a\u00020\u00062\u0006\u0010\u000b\u001a\u00020\u0006H\u0001ø\u0001\u0000¢\u0006\u0004\b\u0015\u0010\u0016\u001a\"\u0010\u0017\u001a\u00020\u00062\u0006\u0010\n\u001a\u00020\u00062\u0006\u0010\u000b\u001a\u00020\u0006H\u0001ø\u0001\u0000¢\u0006\u0004\b\u0018\u0010\u0016\u001a\u0010\u0010\u0019\u001a\u00020\u00032\u0006\u0010\u0002\u001a\u00020\u0013H\u0001\u001a\u0010\u0010\u001a\u001a\u00020\u001b2\u0006\u0010\u0002\u001a\u00020\u0013H\u0000\u001a\u0018\u0010\u001a\u001a\u00020\u001b2\u0006\u0010\u0002\u001a\u00020\u00132\u0006\u0010\u001c\u001a\u00020\tH\u0000\u0002\u0004\n\u0002\b\u0019¨\u0006\u001d"}, mo24952d2 = {"doubleToUInt", "Lkotlin/UInt;", "v", "", "(D)I", "doubleToULong", "Lkotlin/ULong;", "(D)J", "uintCompare", "", "v1", "v2", "uintDivide", "uintDivide-J1ME1BU", "(II)I", "uintRemainder", "uintRemainder-J1ME1BU", "uintToDouble", "ulongCompare", "", "ulongDivide", "ulongDivide-eb3DHEI", "(JJ)J", "ulongRemainder", "ulongRemainder-eb3DHEI", "ulongToDouble", "ulongToString", "", "base", "kotlin-stdlib"}, mo24953k = 2, mo24954mv = {1, 1, 15})
...
public final class UnsignedKt {
    ...
    public static final int m1577uintDivideJ1ME1BU(int v1, int v2) {
        return UInt.m1351constructorimpl((int) ((((long) v1) & 4294967295L) / (4294967295L & ((long) v2))));
    }

    /* renamed from: uintRemainder-J1ME1BU reason: not valid java name */
    public static final int m1578uintRemainderJ1ME1BU(int v1, int v2) {
        return UInt.m1351constructorimpl((int) ((((long) v1) & 4294967295L) % (4294967295L & ((long) v2))));
    }

    /* renamed from: ulongDivide-eb3DHEI reason: not valid java name */
    public static final long m1579ulongDivideeb3DHEI(long v1, long v2) {
        long dividend = v1;
        long divisor = v2;
        long j = 0;
        if (divisor < 0) {
            ...
            return ULong.m1420constructorimpl(j);
        } else if (dividend >= 0) {
            return ULong.m1420constructorimpl(dividend / divisor);
        } else {
            int i = 1;
            long quotient = ((dividend >>> 1) / divisor) << 1;
            if (ulongCompare(ULong.m1420constructorimpl(dividend - (quotient * divisor)), ULong.m1420constructorimpl(divisor)) < 0) {
                i = 0;
            }
            return ULong.m1420constructorimpl(((long) i) + quotient);
        }
    }

    /* renamed from: ulongRemainder-eb3DHEI reason: not valid java name */
    public static final long m1580ulongRemaindereb3DHEI(long v1, long v2) {
        long j;
        long dividend = v1;
        long divisor = v2;
        long j2 = 0;
        if (divisor < 0) {
            if (ulongCompare(v1, v2) < 0) {
                ...
                j = ULong.m1420constructorimpl(v1 - v2);
            }
            return j;
        } else if (dividend >= 0) {
            return ULong.m1420constructorimpl(dividend % divisor);
            ...
            if (ulongCompare(ULong.m1420constructorimpl(rem), ULong.m1420constructorimpl(divisor)) >= 0) {
                j2 = divisor;
            }
            return ULong.m1420constructorimpl(rem - j2);
        }
    }
    ...
    public static final int doubleToUInt(double v) {
        ...
        if (v <= d) {
            return UInt.m1351constructorimpl((int) v);
        }
        return UInt.m1351constructorimpl(UInt.m1351constructorimpl((int) (v - d)) + UInt.m1351constructorimpl(Integer.MAX_VALUE));
    }
    ...
    public static final long doubleToULong(double v) {
        ...
        if (v < ((double) LongCompanionObject.MAX_VALUE)) {
            return ULong.m1420constructorimpl((long) v);
        }
        return ULong.m1420constructorimpl(ULong.m1420constructorimpl((long) (v - 9.223372036854776E18d)) - Long.MIN_VALUE);
    }
