...
public final class ULongRange extends ULongProgression implements ClosedRange<ULong> {
    ...
    @Metadata(mo24950bv = {1, 0, 3}, mo24951d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u0011\u0010\u0003\u001a\u00020\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0005\u0010\u0006¨\u0006\u0007"}, mo24952d2 = {"Lkotlin/ranges/ULongRange$Companion;", "", "()V", "EMPTY", "Lkotlin/ranges/ULongRange;", "getEMPTY", "()Lkotlin/ranges/ULongRange;", "kotlin-stdlib"}, mo24953k = 1, mo24954mv = {1, 1, 15})
    /* compiled from: ULongRange.kt */
    ...
    public /* bridge */ /* synthetic */ boolean contains(Comparable comparable) {
        return m2145containsVKZWuLQ(((ULong) comparable).m1463unboximpl());
    }

    public ULong getStart() {
        return ULong.m1414boximpl(getFirst());
    }

    public ULong getEndInclusive() {
        return ULong.m1414boximpl(getLast());
    }

    /* renamed from: contains-VKZWuLQ reason: not valid java name */
    public boolean m2145containsVKZWuLQ(long value) {
    ...
    public int hashCode() {
        ...
        return ((int) ULong.m1420constructorimpl(getLast() ^ ULong.m1420constructorimpl(getLast() >>> 32))) + (((int) ULong.m1420constructorimpl(getFirst() ^ ULong.m1420constructorimpl(getFirst() >>> 32))) * 31);
    }

    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append(ULong.m1457toStringimpl(getFirst()));
        sb.append("..");
        sb.append(ULong.m1457toStringimpl(getLast()));
        return sb.toString();
    }
