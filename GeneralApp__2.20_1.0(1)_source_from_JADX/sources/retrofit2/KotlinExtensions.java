...
public final class KotlinExtensions {
    ...
    public static final <T> Object await(Call<T> $receiver, Continuation<? super T> continuation) {
        CancellableContinuationImpl cancellable$iv = new CancellableContinuationImpl(IntrinsicsKt.intercepted(continuation), 1);
        CancellableContinuation continuation2 = (CancellableContinuation) cancellable$iv;
        continuation2.invokeOnCancellation(new C1335x19835f10($receiver));
        $receiver.enqueue(new KotlinExtensions$await$2$2(continuation2));
    ...
    public static final <T> Object awaitNullable(Call<T> $receiver, Continuation<? super T> continuation) {
        CancellableContinuationImpl cancellable$iv = new CancellableContinuationImpl(IntrinsicsKt.intercepted(continuation), 1);
        CancellableContinuation continuation2 = (CancellableContinuation) cancellable$iv;
        continuation2.invokeOnCancellation(new C1336x19835f11($receiver));
        $receiver.enqueue(new KotlinExtensions$await$4$2(continuation2));
        Object result = cancellable$iv.getResult();
        if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
            DebugProbesKt.probeCoroutineSuspended(continuation);
        }
    ...
    public static final <T> Object awaitResponse(Call<T> $receiver, Continuation<? super Response<T>> continuation) {
        CancellableContinuationImpl cancellable$iv = new CancellableContinuationImpl(IntrinsicsKt.intercepted(continuation), 1);
        CancellableContinuation continuation2 = (CancellableContinuation) cancellable$iv;
        continuation2.invokeOnCancellation(new C1337xc95e9eb1($receiver));
        $receiver.enqueue(new KotlinExtensions$awaitResponse$2$2(continuation2));
        Object result = cancellable$iv.getResult();
        if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
            DebugProbesKt.probeCoroutineSuspended(continuation);
        }
