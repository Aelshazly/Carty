    ...
    static final class Body<T> extends ParameterHandler<T> {
        ...
        public void apply(RequestBuilder builder, @Nullable T value) {
            if (value != null) {
                ...
                throw Utils.parameterError(this.method, this.f263p, "Body parameter value must not be null.", new Object[0]);
            }
        }
    }
            ...
            if (value != null) {
                for (Entry<String, T> entry : value.entrySet()) {
                    ...
                    if (entryKey != null) {
                        ...
                        throw Utils.parameterError(this.method, this.f264p, "Field map contained null key.", new Object[0]);
                    }
                }
                return;
            }
            throw Utils.parameterError(this.method, this.f264p, "Field map was null.", new Object[0]);
        }
    }
            ...
            if (value != null) {
                for (Entry<String, T> entry : value.entrySet()) {
                    ...
                    if (headerName != null) {
                        ...
                        throw Utils.parameterError(this.method, this.f265p, "Header map contained null key.", new Object[0]);
                    }
                }
                return;
            }
            throw Utils.parameterError(this.method, this.f265p, "Header map was null.", new Object[0]);
        }
    }
    ...
    static final class Headers extends ParameterHandler<okhttp3.Headers> {
        ...
        public void apply(RequestBuilder builder, @Nullable okhttp3.Headers headers) {
            if (headers != null) {
                ...
                throw Utils.parameterError(this.method, this.f266p, "Headers parameter must not be null.", new Object[0]);
            }
        }
    }
                ...
                for (Entry<String, T> entry : value.entrySet()) {
                    ...
                    if (entryKey != null) {
                        ...
                        if (entryValue != null) {
                            ...
                            sb.append(entryKey);
                            sb.append("\"");
                            builder.addPart(okhttp3.Headers.m127of("Content-Disposition", sb.toString(), MIME.CONTENT_TRANSFER_ENC, this.transferEncoding), (RequestBody) this.valueConverter.convert(entryValue));
                        } else {
                            Method method2 = this.method;
                            int i = this.f268p;
                            StringBuilder sb2 = new StringBuilder();
                        ...
                        throw Utils.parameterError(this.method, this.f268p, "Part map contained null key.", new Object[0]);
                    }
                }
                return;
            }
            throw Utils.parameterError(this.method, this.f268p, "Part map was null.", new Object[0]);
        }
    }
            ...
            if (value != null) {
                for (Entry<String, T> entry : value.entrySet()) {
                    ...
                    if (entryKey != null) {
                        ...
                        throw Utils.parameterError(this.method, this.f270p, "Query map contained null key.", new Object[0]);
                    }
                }
                return;
            }
            throw Utils.parameterError(this.method, this.f270p, "Query map was null", new Object[0]);
        }
    }
    ...
    static final class RelativeUrl extends ParameterHandler<Object> {
        ...
        public void apply(RequestBuilder builder, @Nullable Object value) {
            if (value != null) {
                ...
                throw Utils.parameterError(this.method, this.f271p, "@Url parameter is null.", new Object[0]);
            }
        }
    }
