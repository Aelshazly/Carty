...
@Metadata(mo24950bv = {1, 0, 3}, mo24951d1 = {"\u0000%\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0003\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000*\u0001\u0000\b\n\u0018\u00002\b\u0012\u0004\u0012\u00028\u00000\u0001J\u001e\u0010\u0002\u001a\u00020\u00032\f\u0010\u0004\u001a\b\u0012\u0004\u0012\u00028\u00000\u00052\u0006\u0010\u0006\u001a\u00020\u0007H\u0016J$\u0010\b\u001a\u00020\u00032\f\u0010\u0004\u001a\b\u0012\u0004\u0012\u00028\u00000\u00052\f\u0010\t\u001a\b\u0012\u0004\u0012\u00028\u00000\nH\u0016¨\u0006\u000b"}, mo24952d2 = {"retrofit2/KotlinExtensions$await$2$2", "Lretrofit2/Callback;", "onFailure", "", "call", "Lretrofit2/Call;", "t", "", "onResponse", "response", "Lretrofit2/Response;", "retrofit"}, mo24953k = 1, mo24954mv = {1, 1, 13})
...
public final class KotlinExtensions$await$2$2 implements Callback<T> {
    ...
    public void onResponse(Call<T> call, Response<T> response) {
        ...
        if (response.isSuccessful()) {
            ...
            if (body == null) {
                ...
                continuation.resumeWith(Result.m1266constructorimpl(ResultKt.createFailure(e)));
                return;
            }
            Continuation continuation2 = this.$continuation;
            Companion companion2 = Result.Companion;
            continuation2.resumeWith(Result.m1266constructorimpl(body));
            return;
        }
        ...
        continuation3.resumeWith(Result.m1266constructorimpl(ResultKt.createFailure(httpException)));
    }
    ...
    public void onFailure(Call<T> call, Throwable t) {
        ...
        Continuation continuation = this.$continuation;
        Companion companion = Result.Companion;
        continuation.resumeWith(Result.m1266constructorimpl(ResultKt.createFailure(t)));
    }
}
