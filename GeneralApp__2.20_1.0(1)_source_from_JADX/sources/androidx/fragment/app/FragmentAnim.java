...
class FragmentAnim {
    ...
    static AnimationOrAnimator loadAnimation(Context context, FragmentContainer fragmentContainer, Fragment fragment, boolean enter) {
        ...
        if (!(container == null || container.getTag(C1016R.C1019id.visible_removing_fragment_view_tag) == null)) {
            container.setTag(C1016R.C1019id.visible_removing_fragment_view_tag, null);
        }
    ...
    static void animateRemoveFragment(final Fragment fragment, AnimationOrAnimator anim, final Callback callback) {
        ...
        C02043 r0 = new AnimatorListenerAdapter() {
    ...
    private static int transitToAnimResourceId(int transit, boolean enter) {
        if (transit == 4097) {
            return enter ? C1016R.anim.fragment_open_enter : C1016R.anim.fragment_open_exit;
        } else if (transit == 4099) {
            return enter ? C1016R.anim.fragment_fade_enter : C1016R.anim.fragment_fade_exit;
        } else if (transit != 8194) {
            return -1;
        } else {
            return enter ? C1016R.anim.fragment_close_enter : C1016R.anim.fragment_close_exit;
        }
    }
}
