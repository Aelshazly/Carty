...
public class EditTextPreference extends DialogPreference {
    ...
    public EditTextPreference(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C1048R.styleable.EditTextPreference, defStyleAttr, defStyleRes);
        if (TypedArrayUtils.getBoolean(a, C1048R.styleable.EditTextPreference_useSimpleSummaryProvider, C1048R.styleable.EditTextPreference_useSimpleSummaryProvider, false)) {
    ...
    public EditTextPreference(Context context, AttributeSet attrs) {
        this(context, attrs, TypedArrayUtils.getAttr(context, C1048R.attr.editTextPreferenceStyle, 16842898));
    }
