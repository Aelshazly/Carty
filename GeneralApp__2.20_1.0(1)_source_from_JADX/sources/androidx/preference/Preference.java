...
public class Preference implements Comparable<Preference> {
    ...
    private static class OnPreferenceCopyListener implements OnCreateContextMenuListener, OnMenuItemClickListener {
        ...
        public void onCreateContextMenu(ContextMenu menu, View v, ContextMenuInfo menuInfo) {
            ...
            if (this.mPreference.isCopyingEnabled() && !TextUtils.isEmpty(summary)) {
                ...
                menu.add(0, 0, 0, C1048R.string.copy).setOnMenuItemClickListener(this);
            }
        }
        ...
        public boolean onMenuItemClick(MenuItem item) {
            ...
            CharSequence summary = this.mPreference.getSummary();
            clipboard.setPrimaryClip(ClipData.newPlainText(Preference.CLIPBOARD_ID, summary));
            Toast.makeText(this.mPreference.getContext(), this.mPreference.getContext().getString(C1048R.string.preference_copied, new Object[]{summary}), 0).show();
            return true;
        }
    }
    ...
    public Preference(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mLayoutResId = C1048R.layout.preference;
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C1048R.styleable.Preference, defStyleAttr, defStyleRes);
        this.mIconResId = TypedArrayUtils.getResourceId(a, C1048R.styleable.Preference_icon, C1048R.styleable.Preference_android_icon, 0);
        this.mKey = TypedArrayUtils.getString(a, C1048R.styleable.Preference_key, C1048R.styleable.Preference_android_key);
        this.mTitle = TypedArrayUtils.getText(a, C1048R.styleable.Preference_title, C1048R.styleable.Preference_android_title);
        this.mSummary = TypedArrayUtils.getText(a, C1048R.styleable.Preference_summary, C1048R.styleable.Preference_android_summary);
        this.mOrder = TypedArrayUtils.getInt(a, C1048R.styleable.Preference_order, C1048R.styleable.Preference_android_order, Integer.MAX_VALUE);
        this.mFragment = TypedArrayUtils.getString(a, C1048R.styleable.Preference_fragment, C1048R.styleable.Preference_android_fragment);
        this.mLayoutResId = TypedArrayUtils.getResourceId(a, C1048R.styleable.Preference_layout, C1048R.styleable.Preference_android_layout, C1048R.layout.preference);
        this.mWidgetLayoutResId = TypedArrayUtils.getResourceId(a, C1048R.styleable.Preference_widgetLayout, C1048R.styleable.Preference_android_widgetLayout, 0);
        this.mEnabled = TypedArrayUtils.getBoolean(a, C1048R.styleable.Preference_enabled, C1048R.styleable.Preference_android_enabled, true);
        this.mSelectable = TypedArrayUtils.getBoolean(a, C1048R.styleable.Preference_selectable, C1048R.styleable.Preference_android_selectable, true);
        this.mPersistent = TypedArrayUtils.getBoolean(a, C1048R.styleable.Preference_persistent, C1048R.styleable.Preference_android_persistent, true);
        this.mDependencyKey = TypedArrayUtils.getString(a, C1048R.styleable.Preference_dependency, C1048R.styleable.Preference_android_dependency);
        this.mAllowDividerAbove = TypedArrayUtils.getBoolean(a, C1048R.styleable.Preference_allowDividerAbove, C1048R.styleable.Preference_allowDividerAbove, this.mSelectable);
        this.mAllowDividerBelow = TypedArrayUtils.getBoolean(a, C1048R.styleable.Preference_allowDividerBelow, C1048R.styleable.Preference_allowDividerBelow, this.mSelectable);
        if (a.hasValue(C1048R.styleable.Preference_defaultValue)) {
            this.mDefaultValue = onGetDefaultValue(a, C1048R.styleable.Preference_defaultValue);
        } else if (a.hasValue(C1048R.styleable.Preference_android_defaultValue)) {
            this.mDefaultValue = onGetDefaultValue(a, C1048R.styleable.Preference_android_defaultValue);
        }
        this.mShouldDisableView = TypedArrayUtils.getBoolean(a, C1048R.styleable.Preference_shouldDisableView, C1048R.styleable.Preference_android_shouldDisableView, true);
        this.mHasSingleLineTitleAttr = a.hasValue(C1048R.styleable.Preference_singleLineTitle);
        if (this.mHasSingleLineTitleAttr) {
            this.mSingleLineTitle = TypedArrayUtils.getBoolean(a, C1048R.styleable.Preference_singleLineTitle, C1048R.styleable.Preference_android_singleLineTitle, true);
        }
        this.mIconSpaceReserved = TypedArrayUtils.getBoolean(a, C1048R.styleable.Preference_iconSpaceReserved, C1048R.styleable.Preference_android_iconSpaceReserved, false);
        this.mVisible = TypedArrayUtils.getBoolean(a, C1048R.styleable.Preference_isPreferenceVisible, C1048R.styleable.Preference_isPreferenceVisible, true);
        this.mCopyingEnabled = TypedArrayUtils.getBoolean(a, C1048R.styleable.Preference_enableCopying, C1048R.styleable.Preference_enableCopying, false);
        a.recycle();
    }
    ...
    public Preference(Context context, AttributeSet attrs) {
        this(context, attrs, TypedArrayUtils.getAttr(context, C1048R.attr.preferenceStyle, 16842894));
    }
    ...
    public void onBindViewHolder(PreferenceViewHolder holder) {
        ...
        View imageFrame = holder.findViewById(C1048R.C1051id.icon_frame);
        if (imageFrame == null) {
    ...
    private void unregisterDependency() {
        ...
        if (str != null) {
            Preference oldDependency = findPreferenceInHierarchy(str);
