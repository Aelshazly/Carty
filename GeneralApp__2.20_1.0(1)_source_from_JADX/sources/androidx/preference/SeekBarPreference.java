...
public class SeekBarPreference extends Preference {
    ...
    public SeekBarPreference(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C1048R.styleable.SeekBarPreference, defStyleAttr, defStyleRes);
        this.mMin = a.getInt(C1048R.styleable.SeekBarPreference_min, 0);
        setMax(a.getInt(C1048R.styleable.SeekBarPreference_android_max, 100));
        setSeekBarIncrement(a.getInt(C1048R.styleable.SeekBarPreference_seekBarIncrement, 0));
        this.mAdjustable = a.getBoolean(C1048R.styleable.SeekBarPreference_adjustable, true);
        this.mShowSeekBarValue = a.getBoolean(C1048R.styleable.SeekBarPreference_showSeekBarValue, false);
        this.mUpdatesContinuously = a.getBoolean(C1048R.styleable.SeekBarPreference_updatesContinuously, false);
        a.recycle();
    }
    ...
    public SeekBarPreference(Context context, AttributeSet attrs) {
        this(context, attrs, C1048R.attr.seekBarPreferenceStyle);
    }
    ...
    public void onBindViewHolder(PreferenceViewHolder view) {
        ...
        this.mSeekBar = (SeekBar) view.findViewById(C1048R.C1051id.seekbar);
        this.mSeekBarValueTextView = (TextView) view.findViewById(C1048R.C1051id.seekbar_value);
