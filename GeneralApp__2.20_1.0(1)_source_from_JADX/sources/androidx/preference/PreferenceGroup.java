...
public abstract class PreferenceGroup extends Preference {
    ...
    public PreferenceGroup(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C1048R.styleable.PreferenceGroup, defStyleAttr, defStyleRes);
        this.mOrderingAsAdded = TypedArrayUtils.getBoolean(a, C1048R.styleable.PreferenceGroup_orderingFromXml, C1048R.styleable.PreferenceGroup_orderingFromXml, true);
        if (a.hasValue(C1048R.styleable.PreferenceGroup_initialExpandedChildrenCount)) {
            setInitialExpandedChildrenCount(TypedArrayUtils.getInt(a, C1048R.styleable.PreferenceGroup_initialExpandedChildrenCount, C1048R.styleable.PreferenceGroup_initialExpandedChildrenCount, Integer.MAX_VALUE));
        }
        a.recycle();
    }
    ...
    public Preference getPreference(int index) {
        return (Preference) this.mPreferences.get(index);
    }
    ...
    public boolean addPreference(Preference preference) {
        ...
        if (key2 == null || !this.mIdRecycleCache.containsKey(key2)) {
            ...
            id = ((Long) this.mIdRecycleCache.get(key2)).longValue();
    ...
    public void removeAll() {
        synchronized (this) {
            ...
            for (int i = preferences.size() - 1; i >= 0; i--) {
                removePreferenceInt((Preference) preferences.get(0));
            }
        }
        notifyHierarchyChanged();
    }
