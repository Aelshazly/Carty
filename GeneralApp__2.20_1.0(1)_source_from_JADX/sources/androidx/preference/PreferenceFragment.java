...
public abstract class PreferenceFragment extends Fragment implements OnPreferenceTreeClickListener, OnDisplayPreferenceDialogListener, OnNavigateToScreenListener, TargetFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        TypedArray a = this.mStyledContext.obtainStyledAttributes(null, C1048R.styleable.PreferenceFragment, TypedArrayUtils.getAttr(this.mStyledContext, C1048R.attr.preferenceFragmentStyle, 16844038), 0);
        this.mLayoutResId = a.getResourceId(C1048R.styleable.PreferenceFragment_android_layout, this.mLayoutResId);
        Drawable divider = a.getDrawable(C1048R.styleable.PreferenceFragment_android_divider);
        int dividerHeight = a.getDimensionPixelSize(C1048R.styleable.PreferenceFragment_android_dividerHeight, -1);
        boolean allowDividerAfterLastItem = a.getBoolean(C1048R.styleable.PreferenceFragment_allowDividerAfterLastItem, true);
        a.recycle();
