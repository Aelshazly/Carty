...
public class MultiSelectListPreference extends DialogPreference {
    ...
    public MultiSelectListPreference(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mValues = new HashSet();
        TypedArray a = context.obtainStyledAttributes(attrs, C1048R.styleable.MultiSelectListPreference, defStyleAttr, defStyleRes);
        this.mEntries = TypedArrayUtils.getTextArray(a, C1048R.styleable.MultiSelectListPreference_entries, C1048R.styleable.MultiSelectListPreference_android_entries);
        this.mEntryValues = TypedArrayUtils.getTextArray(a, C1048R.styleable.MultiSelectListPreference_entryValues, C1048R.styleable.MultiSelectListPreference_android_entryValues);
        a.recycle();
    }
