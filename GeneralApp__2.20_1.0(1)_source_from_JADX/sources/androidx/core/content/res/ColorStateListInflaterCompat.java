    ...
    private static ColorStateList inflate(Resources r, XmlPullParser parser, AttributeSet attrs, Theme theme) throws XmlPullParserException, IOException {
        ...
        while (true) {
            ...
            if (depth < innerDepth && type == 3) {
                ...
                TypedArray a = obtainAttributes(r, theme, attributeSet, C1002R.styleable.ColorStateListItem);
                int baseColor = a.getColor(C1002R.styleable.ColorStateListItem_android_color, -65281);
                float alphaMod = 1.0f;
                if (a.hasValue(C1002R.styleable.ColorStateListItem_android_alpha)) {
                    alphaMod = a.getFloat(C1002R.styleable.ColorStateListItem_android_alpha, 1.0f);
                } else if (a.hasValue(C1002R.styleable.ColorStateListItem_alpha)) {
                    alphaMod = a.getFloat(C1002R.styleable.ColorStateListItem_alpha, 1.0f);
                }
                a.recycle();
                ...
                while (i4 < numAttrs) {
                    ...
                    TypedArray a2 = a;
                    if (!(stateResId == 16843173 || stateResId == 16843551 || stateResId == C1002R.attr.alpha)) {
                        int j2 = j + 1;
