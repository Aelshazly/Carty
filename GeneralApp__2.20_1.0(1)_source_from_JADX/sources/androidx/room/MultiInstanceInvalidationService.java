...
public class MultiInstanceInvalidationService extends Service {
    private final Stub mBinder = new Stub() {
        ...
        public void broadcastInvalidation(int clientId, String[] tables) {
            synchronized (MultiInstanceInvalidationService.this.mCallbackList) {
                String name = (String) MultiInstanceInvalidationService.this.mClientNames.get(Integer.valueOf(clientId));
                if (name == null) {
                ...
                for (int i = 0; i < count; i++) {
                    try {
                        ...
                        String targetName = (String) MultiInstanceInvalidationService.this.mClientNames.get(Integer.valueOf(targetClientId));
