...
public class Scene {
    ...
    public static Scene getSceneForLayout(ViewGroup sceneRoot, int layoutId, Context context) {
        SparseArray sparseArray = (SparseArray) sceneRoot.getTag(C1070R.C1073id.transition_scene_layoutid_cache);
        if (sparseArray == null) {
            sparseArray = new SparseArray();
            sceneRoot.setTag(C1070R.C1073id.transition_scene_layoutid_cache, sparseArray);
        }
    ...
    static void setCurrentScene(ViewGroup sceneRoot, Scene scene) {
        sceneRoot.setTag(C1070R.C1073id.transition_current_scene, scene);
    }

    public static Scene getCurrentScene(ViewGroup sceneRoot) {
        return (Scene) sceneRoot.getTag(C1070R.C1073id.transition_current_scene);
    }
