...
public interface SupportSQLiteOpenHelper {
    ...
    public static abstract class Callback {
        ...
        /* JADX WARNING: Removed duplicated region for block: B:8:0x002f A[ExcHandler: all (r1v7 'th' java.lang.Throwable A[CUSTOM_DECLARE]), PHI: r0 
          PHI: (r0v5 java.util.List) = (r0v3 java.util.List), (r0v4 java.util.List), (r0v4 java.util.List) binds: [B:5:0x0029, B:10:0x0032, B:11:?] A[DONT_GENERATE, DONT_INLINE], Splitter:B:5:0x0029] */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public void onCorruption(androidx.sqlite.p004db.SupportSQLiteDatabase r6) {
            /*
                r5 = this;
                ...
                try {
                    if (VERSION.SDK_INT >= 16) {
                        ...
                        try {
                            ...
                            Log.e(str, "error while deleting corrupted database file", error);
                        }
                    }
                } catch (Exception e) {
                    Log.w(str, "delete failed: ", e);
                }
            }
        }
    }
