...
public class StaggeredGridLayoutManager extends LayoutManager implements ScrollVectorProvider {
    ...
    public void onInitializeAccessibilityNodeInfoForItem(Recycler recycler, State state, View host, AccessibilityNodeInfoCompat info) {
        ...
        if (this.mOrientation == 0) {
            info.setCollectionItemInfo(CollectionItemInfoCompat.obtain(sglp.getSpanIndex(), sglp.mFullSpan ? this.mSpanCount : 1, -1, -1, false, false));
        } else {
            info.setCollectionItemInfo(CollectionItemInfoCompat.obtain(-1, -1, sglp.getSpanIndex(), sglp.mFullSpan ? this.mSpanCount : 1, false, false));
        }
    }
    ...
    private int fill(androidx.recyclerview.widget.RecyclerView.Recycler r23, androidx.recyclerview.widget.LayoutState r24, androidx.recyclerview.widget.RecyclerView.State r25) {
        ...
        L_0x00e9:
            ...
            boolean r2 = r15.mFullSpan
            if (r2 == 0) goto L_0x0105
            androidx.recyclerview.widget.StaggeredGridLayoutManager$LazySpanLookup$FullSpanItem r2 = r6.createFullSpanItemFromStart(r0)
            r2.mGapDir = r10
            r2.mPosition = r5
