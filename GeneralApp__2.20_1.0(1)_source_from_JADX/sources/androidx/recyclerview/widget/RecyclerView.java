...
import androidx.recyclerview.C1054R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    public static abstract class LayoutManager {
        ...
        public static Properties getProperties(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            TypedArray a = context.obtainStyledAttributes(attrs, C1054R.styleable.RecyclerView, defStyleAttr, defStyleRes);
            properties.orientation = a.getInt(C1054R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = a.getInt(C1054R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = a.getBoolean(C1054R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = a.getBoolean(C1054R.styleable.RecyclerView_stackFromEnd, false);
            a.recycle();
            return properties;
        }
    ...
    public final class Recycler {
            ...
            if (RecyclerView.this.isAccessibilityEnabled()) {
                ...
                if (RecyclerView.this.mAccessibilityDelegate != null) {
                    ...
                    if (itemDelegate instanceof ItemDelegate) {
                        ((ItemDelegate) itemDelegate).saveOriginalDelegate(itemView);
                    }
        ...
        public void addViewHolderToRecycledViewPool(ViewHolder holder, boolean dispatchRecycled) {
            ...
            if (RecyclerView.this.mAccessibilityDelegate != null) {
                ...
                if (itemDelegate instanceof ItemDelegate) {
                    originalDelegate = ((ItemDelegate) itemDelegate).getAndRemoveOriginalDelegateForItem(itemView);
                }
    ...
    public RecyclerView(Context context, AttributeSet attrs) {
        this(context, attrs, C1054R.attr.recyclerViewStyle);
    }
    ...
    public RecyclerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context2.obtainStyledAttributes(attributeSet, C1054R.styleable.RecyclerView, i, 0);
        if (VERSION.SDK_INT >= 29) {
            saveAttributeDataForStyleable(context, C1054R.styleable.RecyclerView, attrs, a, defStyleAttr, 0);
        }
        String layoutManagerName = a.getString(C1054R.styleable.RecyclerView_layoutManager);
        int descendantFocusability = a.getInt(C1054R.styleable.RecyclerView_android_descendantFocusability, -1);
        if (descendantFocusability == -1) {
            setDescendantFocusability(262144);
        }
        this.mClipToPadding = a.getBoolean(C1054R.styleable.RecyclerView_android_clipToPadding, true);
        this.mEnableFastScroller = a.getBoolean(C1054R.styleable.RecyclerView_fastScrollEnabled, false);
        if (this.mEnableFastScroller) {
            initFastScroller((StateListDrawable) a.getDrawable(C1054R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), a.getDrawable(C1054R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) a.getDrawable(C1054R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), a.getDrawable(C1054R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
        }
        a.recycle();
    ...
    public void initFastScroller(StateListDrawable verticalThumbDrawable, Drawable verticalTrackDrawable, StateListDrawable horizontalThumbDrawable, Drawable horizontalTrackDrawable) {
        ...
        new FastScroller(this, verticalThumbDrawable, verticalTrackDrawable, horizontalThumbDrawable, horizontalTrackDrawable, resources.getDimensionPixelSize(C1054R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C1054R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C1054R.dimen.fastscroll_margin));
    }
